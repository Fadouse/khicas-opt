...
for sig in ('  void decompose_prod(', '  gen extract_cst(',
            ...
            '  static bool integrate_quartic_trig(', '  static bool integrate_high_frequency_trig(', '  static bool integration_resource_rational(', '  static bool integrate_composed_binomial(', '  static bool integration_dilog_form(', '  static bool integrate_dilog_primitive(', '  static bool integrate_log_trig_primitive(', '  static bool integrate_compact_primitive(',
