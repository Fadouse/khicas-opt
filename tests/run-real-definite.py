...
for sig in (
    ...
    "  static bool integrate_binomial_chain(",
    "  static bool integration_quadratic(",
    "  static bool integrate_reciprocal_quartic(",
    "  static bool integrate_quartic_trig(",
    "  static bool integrate_high_frequency_trig(",
    "  static bool integration_resource_rational(",
    "  static bool integrate_composed_binomial(",
    "  static bool integration_dilog_form(",
    "  static bool integrate_dilog_primitive(",
    "  static bool integrate_log_trig_primitive(",
    "  static bool integrate_compact_primitive(",
    "  static bool integrate_sine_dirichlet(",
    "  static bool integrate_logistic_moment(",
    "  static bool integrate_weighted_reflection(",
    "  static bool integrate_decay_transform(",
    "  static bool integration_square_root(",
    "  static bool integrate_atan_square(",
    "  static bool integrate_log_trig(",
    "  static bool integrate_thermal_moment(",
    ...
    "  static bool integration_harmonic_real(",
    "  static bool integration_harmonic_product(",
    "  static bool integration_harmonic_terms(",
    "  static bool integration_gaussian_quadratic(",
    "  static bool integrate_gaussian_erf(",
    "  static bool integrate_laplace_difference(",
    ...
    "  static bool integrate_mellin_two_binomials(",
    "  static bool integration_exp_affine(",
    "  static bool integrate_exp_difference(",
    "  static bool integration_chain_add(",
    "  static bool integration_chain_terms(",
    "  static bool integration_chain_endpoint(",
    "  static bool integrate_erf_chain(",
    "  static bool integration_rectangle_term(",
    "  static bool integrate_atan_rectangle_pair(",
    "  static bool integrate_gaussian_erf_exp(",
    ...
    "  static bool integrate_complementary_ratio(",
    "  static bool integrate_cauchy_fourier(",
    "  static bool integrate_unit_log_arc(",
    "  static bool integrate_positive_cosine_kernel(",
    "  static bool integrate_dilog_definite(",
    "  static bool integrate_compact_definite(",
    "  static bool integrate_real_root(",
    "  static bool integrate_residue_kernel(",
    "  bool integration_rational_tail(",
...
with tempfile.TemporaryDirectory(prefix="khicas-real-definite-") as tmp:
    ...
    libs = (
        ...
        + ["-lgiac"]
        + shlex.split(os.environ.get("GIAC_NUMERIC_LIBS", "-lgmp -lmpfr"))
    )
    for test in (
        "real_definite.cc",
        "compact_integrals.cc",
        "cycle1_integrals.cc",
        "cycle2_integrals.cc",
        "user_extra_integrals.cc",
        "cycle3_laplace_integrals.cc",
        "user_matrix_rules.cc",
        "user_matrix_next_rules.cc",
        "parameter_kernel_rules.cc",
        "dilogarithm_rules.cc",
    ):
        subprocess.run(
            flags
