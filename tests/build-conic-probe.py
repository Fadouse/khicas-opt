...
p=argparse.ArgumentParser();p.add_argument('--build-dir',type=Path,required=True);p.add_argument('--simplify-build-dir',type=Path);a=p.parse_args();d=a.build_dir;d.mkdir(parents=True,exist_ok=True)
