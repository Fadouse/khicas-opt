...
checks = [
    ("acos(cos(x))^2", 0, "0"),
    ("acos(cos(x))^2", "2*pi", "0"),
    ("acos(cos(x))^2", "-3*pi", "undef"),
    ("acos(cos(2*x+pi/3))^3", "-pi/6", "0"),
    ("acos(cos(2*x+pi/3))^3", "pi/3", "undef"),
    ("acos(cos(-3*x))^4", 0, "0"),
    ("acos(cos(-3*x))^4", "pi/3", "undef"),
    ("acos(cos(x))", 0, "undef"),
    ("acos(cos(x))", "pi", "undef"),
    ("acos(cos(x^2))", 0, "0"),
    ("acos(cos(pi+x^2))^2", 0, "0"),
    ("acos(cos(x^2))^2", "sqrt(pi)", "undef"),
    ("acos(cos(x^2))^2", "sqrt(2*pi)", "0"),
    ("acos(cos(x))^2", "pi/2", "pi"),
    ("acos(cos(x))^2", "3*pi/2", "-pi"),
]
