...
rows = []
checks = [
    ("sin(x)*abs(sin(2*x))+cos(x)", 0, "0"),
    ("sin(x)*abs(sin(2*x))+cos(x)", "pi", "0"),
    ("sin(x)*abs(sin(2*x))+cos(x)", "pi/2", "undef"),
    ("sin(x)*abs(sin(2*x))+cos(x)", "-pi/2", "undef"),
    ("2*sin(x^2)*abs(sin(x))+x", 0, "1"),
    ("2*sin(x^2)*abs(sin(x))+x", "pi", "undef"),
    ("cos(x)*abs(sin(2*x))+x", "pi/2", "1"),
    ("cos(x)*abs(sin(2*x))+x", 0, "undef"),
    ("exp(x)*abs(sin(3*x))+x", 0, "undef"),
    ("exp(x^2)*abs(cos(2*x))", "pi/4", "undef"),
]
