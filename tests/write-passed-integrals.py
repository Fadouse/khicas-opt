...
SNAPSHOT='checkpoint/polar-stability-cycle8-2026a'
GROUPS=[
 ('极坐标优化第八轮新增积分', 'polar-cycle8-integrals', 'polar-cycle8-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第七轮新增积分', 'polar-cycle7-integrals', 'polar-cycle7-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第六轮新增积分', 'polar-cycle6-integrals', 'polar-cycle6-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第五轮新增积分', 'polar-cycle5-integrals', 'polar-cycle5-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第四轮新增积分', 'polar-cycle4-integrals', 'polar-cycle4-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第三轮新增积分', 'polar-cycle3-integrals', 'polar-cycle3-integrals-polar8-2026a', 'stack'),
 ('极坐标优化第二轮新增积分', 'polar-cycle2-integrals', 'polar-cycle2-integrals-polar8-2026a', 'stack'),
 ('极坐标优化首轮新增积分', 'polar-cycle1-integrals', 'polar-cycle1-integrals-polar8-2026a', 'stack'),
 ('用户原始 8 题', 'user-integrals', 'user-eight-cycle8-polar8-2026a', 'user'),
 ('用户追加 2 题', 'user-extra-integrals', 'user-extra-cycle8-polar8-2026a', 'corpus'),
 ('用户追加 5 题', 'user-challenge-integrals', 'user-challenge-cycle8-polar8-2026a', 'stack'),
 ('MIT / Princeton 题库', 'calculus-corpus', 'calculus-cycle8-polar8-2026a', 'corpus'),
 ('独立泛化题库', 'generalization-corpus', 'generalization-cycle8-polar8-2026a', 'corpus'),
 ('第二轮泛化题库', 'generalization-cycle2', 'cycle2-cycle8-polar8-2026a', 'corpus'),
 ('第三轮泛化题库', 'generalization-cycle3', 'cycle3-cycle8-polar8-2026a', 'corpus'),
 ('第四轮泛化题库', 'generalization-cycle4', 'cycle4-cycle8-polar8-2026a', 'corpus'),
 ('第五轮泛化题库', 'generalization-cycle5', 'cycle5-cycle8-stack-polar8-2026a', 'stack'),
 ('第六轮泛化题库', 'generalization-cycle6', 'cycle6-cycle8-stack-polar8-2026a', 'stack'),
 ('第七轮泛化题库', 'generalization-cycle7', 'cycle7-cycle8-stack-polar8-2026a', 'stack'),
 ('第八轮泛化题库', 'generalization-cycle8', 'cycle8-stack-polar8-2026a', 'stack'),
 ('基础有限区间积分', 'basic-finite-integrals', 'basic-finite-cycle8-polar8-2026a', 'stack'),
 ('误差函数与分母对数变体', 'cycle7-tail-mellin', 'cycle7-tail-mellin-cycle8-stack-polar8-2026a', 'stack'),
 ('Gamma 对数矩变体', 'cycle8-gamma-log', 'cycle8-gamma-log-stack-polar8-2026a', 'stack'),
 ('用户 A1–F6 全模式通过项', 'user-acceptance-passed-dilog', 'user-acceptance-passed-polar8-2026a', 'stack'),
 ('用户前五道未解题', 'user-reported-five-gaps', 'user-reported-five-gaps-polar8-2026a', 'stack'),
 ('验收错题结构变体', 'user-matrix-next', 'user-matrix-next-polar8-2026a', 'stack'),
 ('Li2 换元与端点变体', 'dilogarithm-corpus', 'dilogarithm-corpus-polar8-2026a', 'stack'),
 ('三角对数与主值分支', 'trig-log-corpus', 'trig-log-corpus-polar8-2026a', 'stack'),
 ('混合首轮新增积分', 'mixed-round1-integrals', 'mixed1-integrals-polar8-2026a', 'stack'),
 ('混合第二轮新增积分', 'mixed-round2-integrals', 'mixed2-integrals-polar8-2026a', 'stack'),
]
