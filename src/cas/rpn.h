...
namespace giac {
  ...
  vecteur seqapp_compute(const gen & expr, const vecteur & vars, const gen & UK_k,
                         const gen & UK_kp1, int k, int m, GIAC_CONTEXT);
  ...
  vecteur seqapp_compute(const vecteur & expr, const vecteur & vars, const vecteur & UK_k,
                         const vecteur & UK_kp1, int k, int m, GIAC_CONTEXT);
