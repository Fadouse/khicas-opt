...
namespace giac {
  ...
  gen factor(const gen & e, const identificateur & x, bool withsqrt,
             GIAC_CONTEXT); // factorization w.r.t. x
  ...
  template <class T> gen read1arg_from_stream(nio::ios_base<T> & inf, GIAC_CONTEXT);
#else
...
gen read1arg_from_stream(std::istream & inf, GIAC_CONTEXT);
  ...
  bool sym2r(const gen & e, const gen & iext, const vecteur & l, const vecteur & lv,
             ...
             GIAC_CONTEXT);
  bool sym2r(const gen & e, const vecteur & l, const vecteur & lv, const vecteur & lvnum,
