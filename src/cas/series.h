...
namespace giac {
  ...
  bool series(const sparse_poly1 & s, const unary_function_ptr & u, int direction,
              sparse_poly1 & res, GIAC_CONTEXT); // example series(s,at_sin,0,res,contextptr);
  sparse_poly1 series(const sparse_poly1 & s, const unary_function_ptr & u, int direction,
                      GIAC_CONTEXT); // example series(s,at_sin,0,res,contextptr);
  ...
  bool pmul(const sparse_poly1 & a, const sparse_poly1 & b, sparse_poly1 & res, bool n_truncate,
            const gen & n_valuation, GIAC_CONTEXT);
  ...
  bool pdiv(const sparse_poly1 & a, const sparse_poly1 & b, sparse_poly1 & res, int ordre,
            GIAC_CONTEXT);
  ...
  gen series(const gen & e, const gen & vars, const gen & lim_point, int ordre, int direction,
             GIAC_CONTEXT);
  gen series(const gen & e, const gen & vars, const gen & lim_point, const gen & ordre,
             GIAC_CONTEXT);
  ...
  gen limit_symbolic_preprocess(const gen & e0, const identificateur & x, const gen & lim_point,
                                int direction, GIAC_CONTEXT);
  gen limit(const gen & e, const identificateur & x, const gen & lim_point, int direction,
            GIAC_CONTEXT);
  ...
  // answer is in s
  bool series__SPOL1(const gen & e, const identificateur & x, const gen & lim_point, int ordre,
