...
namespace std {
  ...
  inline unsigned _abs(int i) {
    return i >= 0 ? (i == immvector_max ? 0 : i) : -i;
  }
  ...
  public:
    ...
    giac_reverse_pointer operator+(int n) {
      return ptr - n;
    }
    giac_reverse_pointer operator-(int n) {
      return ptr + n;
    ...
    bool operator==(const giac_reverse_pointer & other) const {
      return ptr == other.ptr;
    }
    bool operator!=(const giac_reverse_pointer & other) const {
      return ptr != other.ptr;
    }
    int operator-(const giac_reverse_pointer & other) const {
      return int(other.ptr - ptr);
    }
  };
...
#define _endalloc_immediate_vect _ptr[1]
  ...
  public:
    ...
    iterator begin() {
      return _taille > 0 ? _begin_immediate_vect : ((_Tp *)_tab);
    }
    iterator end() {
      return _taille > 0 ? _begin_immediate_vect + _abs(_taille) : ((_Tp *)_tab) - _taille;
    }
    ...
    reverse_iterator rbegin() {
      return _taille > 0 ? _begin_immediate_vect + _abs(_taille) - 1 : ((_Tp *)_tab) - _taille - 1;
    }
    reverse_iterator rend() {
      return _taille > 0 ? _begin_immediate_vect - 1 : ((_Tp *)_tab) - 1;
    }
    ...
    size_t capacity() const {
      return _taille < 0 ? (sizeof(int) * IMMEDIATE_VECTOR) / sizeof(_Tp)
                         : _endalloc_immediate_vect - _begin_immediate_vect;
    }
    _Tp & front() {
      return *begin();
    }
    ...
    bool empty() const {
      return _taille == 0 || _taille == immvector_max;
    }
  ...
  template <typename _Tp> void swap(imvector<_Tp> & __x, imvector<_Tp> & __y) {
    __x.swap(__y);
  }
...
namespace std {
  ...
  template <typename _Tp> inline bool operator==(const vector<_Tp> & __x, const vector<_Tp> & __y) {
    if (__x.size() != __y.size())
      return false;
  ...
  template <typename _Tp> inline bool operator>(const _Tp & __x, const _Tp & __y) {
    return __y < __x;
  }
