...
namespace giac {
  ...
  gen linear_apply(const gen & e, const gen & x, gen & remains, int mode, GIAC_CONTEXT,
  ...
  bool is_rewritable_as_f_of(const gen & fu, const gen & u, gen & fx, const gen & gen_x,
                             GIAC_CONTEXT);
  ...
  // integr. of rat. fcns.
  gen integrate_gen_rem(const gen & e, const gen & x, gen & remains_to_integrate, int intmode,
                        GIAC_CONTEXT);
  gen integrate_id_rem(
      const gen & e, const gen & x, gen & remains_to_integrate, GIAC_CONTEXT,
      int intmode); // intmode bit 0 is used for sqrt int control, bit 1 control step/step info, bit 2 indicates surd was replaced
  ...
  bool tegral(const gen & f, const gen & x, const gen & a, const gen & b, const gen & eps, int nmax,
              gen & value, bool exactcheck, GIAC_CONTEXT);
  ...
  gen evalf_int(const gen & f0, const gen & x0, const gen & a, const gen & b, const gen & eps,
                int nmax, bool romberg_method, GIAC_CONTEXT, bool exactcheck = true);
