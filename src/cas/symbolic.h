...
namespace giac {
  ...
  inline int archive_function_index(const unary_function_ptr * f) {
    return archive_function_index(*f);
  };
  ...
  inline int equalposcomp(const unary_function_ptr tab[], const unary_function_ptr * f) {
    return equalposcomp(tab, *f);
  };
  ...
  inline int equalposcomp(const const_unary_function_ptr_ptr tab[], const unary_function_ptr * f) {
    return equalposcomp(tab, *f);
  };
