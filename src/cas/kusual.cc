...
const unary_function_eval __print(1, &_print, _print_s, &printasprint);
  ...
  gen _version(const gen & a, GIAC_CONTEXT) {
    if (a.type == _STRNG && a.subtype == -1)
      return a;
    return string2gen(gettext("Powered by Giac 1.4.9, B. Parisse and R. De Graeve, Institut "
                              "Fourier, Universite Grenoble I, France"),
                      false);
  }
...
const gen * const * table_tan = (const gen **)table_tan_alias;
  ...
  const alias_type reim_op_alias[] = {(alias_type)&__inv,
                                      (alias_type)&__exp,
                                      (alias_type)&__cos,
                                      (alias_type)&__sin,
                                      (alias_type)&__tan,
                                      ...
                                      (alias_type)&__tanh,
                                      (alias_type)&__atan,
                                      (alias_type)&__lnGamma_minus,
                                      (alias_type)&__Gamma,
                                      (alias_type)&__Psi_minus_ln,
                                      (alias_type)&__Psi,
                                      (alias_type)&__Zeta,
                                      (alias_type)&__Eta,
                                      (alias_type)&__sign,
