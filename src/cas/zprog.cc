...
const int rand_max2 = RAND_MAX;
  ...
  gen attoof(const gen & g) {
    ...
    if (g._SYMBptr->feuille.type != _VECT ||
        g._SYMBptr->feuille._VECTptr->size() <=
            1) // not somehting that I recognize as a proper parameter list, just return as before
    ...
    return symbolic(
        at_of,
        attoof(gen(
            v, g._SYMBptr->feuille.subtype))); // return the of(vector with modified indices) gen
  }
  ...
  gen sametoequal(const gen & a) {
    if ((a.type == _SYMB) && (a._SYMBptr->sommet == at_same))
      return symb_equal(a._SYMBptr->feuille._VECTptr->front(),
                        a._SYMBptr->feuille._VECTptr->back());
    else
      return a;
  }

  static void increment_instruction(const const_iterateur & it0, const const_iterateur & itend,
                                    debug_struct * dbgptr) {
  ...
  static gen from_increment(const gen & g) {
    ...
    if (type) {
      ...
      if (f.type != _VECT)
        return symbolic(at_sto,
                        gen(makevecteur(symbolic(at_plus, makevecteur(f, type)), f), _SEQ__VECT));
      vecteur & v = *f._VECTptr;
      if (v.size() != 2)
        return gensizeerr(gettext("from_increment"));
      return symbolic(
          at_sto,
          gen(makevecteur(symbolic(at_plus, gen(makevecteur(v[0], type * v[1]), _SEQ__VECT)), v[0]),
              _SEQ__VECT));
    }
    return g;
  }
  ...
  void debug_print(const gen & e, vector<string> & v, GIAC_CONTEXT) {
    ...
    if (u == at_local) {
      ...
      gen local_global = f._VECTptr->front(), locals(gen2vecteur(local_global)),
          globals(vecteur(0));
    ...
    if (uptr && uptr->op == _for) {
      ...
      if (python) {
        ...
        if (inc.is_symb_of_sommet(at_sto) && inc._SYMBptr->feuille[1].type == _IDNT) {
          ...
          if (inc._SYMBptr->feuille[0] == index + 1 && w[0].is_symb_of_sommet(at_sto) &&
              w[0]._SYMBptr->feuille[1] == index) {
            gen start = w[0]._SYMBptr->feuille[0];
            if (w[1].type == _SYMB &&
                (w[1]._SYMBptr->sommet == at_inferieur_egal ||
                 w[1]._SYMBptr->sommet == at_inferieur_strict) &&
                w[1]._SYMBptr->feuille[0] == index) {
  ...
  void check_local_assign(const gen & g, const vecteur & prog_args, vecteur & res1, vecteur & res2,
                          vecteur & res3, vecteur & res4, bool testequal, GIAC_CONTEXT) {
    ...
    if (g.is_symb_of_sommet(at_local)) {
      ...
      check_local_assign(f._VECTptr->back(), newvars, res1, res2, res3, res4, testequal,
                         contextptr);
      return;
    }
    if (g.is_symb_of_sommet(at_sto)) {
      gen & f = g._SYMBptr->feuille;
      if (f.type == _VECT && f._VECTptr->size() == 2 &&
          f._VECTptr->front().is_symb_of_sommet(at_program)) {
        ...
        if (ff.type == _VECT && ff._VECTptr->size() == 3) {
          ...
          check_local_assign(ff._VECTptr->back(), alt_prog_args, res1, res2, res3, res4, testequal,
                             contextptr);
        }
        return;
      }
    ...
    if (g.is_symb_of_sommet(at_bloc) || g.is_symb_of_sommet(at_for) ||
        g.is_symb_of_sommet(at_pour) || g.is_symb_of_sommet(at_tantque) ||
        g.is_symb_of_sommet(at_si) || g.is_symb_of_sommet(at_sialorssinon) ||
        g.is_symb_of_sommet(at_ifte) || g.is_symb_of_sommet(at_when)) {
      check_local_assign(g._SYMBptr->feuille, prog_args, res1, res2, res3, res4, testequal,
                         contextptr);
      return;
    }
    if (testequal && is_equal(g)) {
      if (g._SYMBptr->feuille.type == _VECT && g._SYMBptr->feuille._VECTptr->size() == 2 &&
          g._SYMBptr->feuille._VECTptr->front().type != _INT_)
        res1.push_back(g);
      return;
    }
    if (g.is_symb_of_sommet(at_of)) {
      ...
      if (python_compat(contextptr) ||
          protecteval(f._VECTptr->front(), 1, contextptr) != f._VECTptr->front())
        check_local_assign(f._VECTptr->back(), prog_args, res1, res2, res3, res4, false,
                           contextptr);
      else
  ...
  bool is_constant_idnt(const gen & g) {
    return g == cst_pi || g == cst_euler_gamma || is_inf(g) || is_undef(g) ||
           (g.type == _IDNT &&
            (strcmp(g._IDNTptr->id_name, "i") == 0 || strcmp(g._IDNTptr->id_name, "None") == 0 ||
             strcmp(g._IDNTptr->id_name, "cmath") == 0 ||
             strcmp(g._IDNTptr->id_name, "math") == 0 ||
             strcmp(g._IDNTptr->id_name, "kandinsky") == 0 ||
             strcmp(g._IDNTptr->id_name, "pass") == 0));
  }
  ...
  static define_unary_function_eval(__warn_equal_in_prog, &_warn_equal_in_prog,
                                    _warn_equal_in_prog_s);
  define_unary_function_ptr5(at_warn_equal_in_prog, alias_at_warn_equal_in_prog,
                             &__warn_equal_in_prog, 0, true);
  ...
  string check_local_assign(const gen & g, GIAC_CONTEXT) {
    ...
    if (g.is_symb_of_sommet(at_sto)) {
      ...
      return res.substr(0, res.size() - 1) + "\n//" + gettext(" compiling ") +
             f._VECTptr->back().print(contextptr) + '\n';
    }
    ...
    if (res2.size() >= 1) {
      ...
      res += gettext(" declared as global variable(s). If symbolic variables are required, declare "
                     "them as local and run purge\n");
    }
    if (res.empty())
  ...
  static string printascheck_type(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    return print_the_type(feuille._VECTptr->front().val, contextptr) + ' ' +
           feuille._VECTptr->back().print(contextptr);
  }
  ...
  gen _check_type(const gen & args, GIAC_CONTEXT) {
    ...
    return gentypeerr(gettext("Argument should be of type ") +
                      print_the_type(args._VECTptr->front().val, contextptr));
  }
  static const char _check_type_s[] = "check_type";
  static define_unary_function_eval2_index(118, __check_type, &symb_check_type, _check_type_s,
                                           &printascheck_type);
  ...
  static string in_printasprogram(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    if ((xcas_mode(contextptr) > 0 || abs_calc_mode(contextptr) == 38) &&
        (feuille._VECTptr->back().type == _SYMB) &&
        (feuille._VECTptr->back()._SYMBptr->sommet == at_local)) {
      test = false;
      ...
      if (!non_init_vars.empty()) {
        if (xcas_mode(contextptr) == 3)
          locals = indent(contextptr) + "Local " +
                   printinner_VECT(non_init_vars, _SEQ__VECT, contextptr);
        else
          locals = indent(contextptr) + (calc38 ? " LOCAL " : "  local ") +
                   printinner_VECT(non_init_vars, _SEQ__VECT, contextptr) + ";";
      }
    ...
    if (test) {
      ...
      return res +
             (fb.type == _VECT ? printasbloc(fb, sommetstr, contextptr) : fb.print(contextptr));
    }
  ...
  gen symb_test_equal(const gen & a, const gen & op, const gen & b) {
    ...
    if (is_inequation(a) || a.is_symb_of_sommet(at_different) ||
        (a.is_symb_of_sommet(at_same) && (b.type != _INT_ || b.subtype != _INT_BOOLEAN))) {
      return symb_and(
          a, symbolic(*op._FUNCptr, gen(makevecteur(a._SYMBptr->feuille[1], b), _SEQ__VECT)));
    }
  ...
  static void replace_keywords(const gen & a, const gen & b, gen & newa, gen & newb, GIAC_CONTEXT) {
    ...
    for (; it != itend; ++it) {
      if (it->is_symb_of_sommet(at_sto) || it->is_symb_of_sommet(at_check_type) ||
          it->is_symb_of_sommet(at_equal)) // FIXME check 1st arg too
        continue;
      if (it->is_symb_of_sommet(at_of)) {
        *logptr(contextptr) << gettext("Invalid argument name ") << *it
                            << gettext(". You should use ")
                            << it->_SYMBptr->feuille._VECTptr->front()
                            << gettext(" instead, even if the argument should be of type function")
                            << '\n';
        *it = it->_SYMBptr->feuille._VECTptr->front();
      }
      if (it->is_symb_of_sommet(at_deuxpoints)) {
    ...
    if (v1.empty())
      ...
      *logptr(contextptr) << gettext("Invalid or typed variable(s) name(s) were replaced by "
                                     "creating special identifiers, check ")
                          << v1 << '\n';
  ...
  symbolic symb_program_sto(const gen & a_, const gen & b_, const gen & c_, const gen & d,
                            bool embedd, GIAC_CONTEXT) {
    gen a(a_), b(b_), c(c_);
    ...
    if (warn) {
      *logptr(contextptr) << gettext("// Parsing ") << d << '\n';
      ...
      if (contains(a, vx_var) && c.type == _SYMB &&
          (!lop(c, at_derive).empty() || !lop(c, at_integrate).empty() || !lop(c, at_int).empty()))
        c = eval(c, 1, contextptr);
      if (c.type == _SYMB && c._SYMBptr->sommet != at_local && c._SYMBptr->sommet != at_bloc &&
          c._SYMBptr->sommet != at_when && c._SYMBptr->sommet != at_for &&
          c._SYMBptr->sommet != at_ifte) {
        ...
        if (!lofc_no_d.empty()) {
          *logptr(contextptr) << gettext("Warning: algebraic function defined in term of others "
                                         "functions may lead to evaluation errors")
                              << '\n';
          CERR << c.print(contextptr) << '\n';
          *logptr(contextptr) << gettext("Perhaps you meant ") << d.print(contextptr)
                              << ":=unapply(" << c.print(contextptr) << ",";
    ...
    for (size_t i = 0; i < newcsto.size(); ++i) {
      ...
      if (val.type == _VECT && (is_numericv(*val._VECTptr) ||
                                is_integer_vecteur(*val._VECTptr))) // in-place modification
        val = symbolic(at_copy, val);
      gen var = newcsto[i]._SYMBptr->feuille._VECTptr->back();
      if (var.type == _FUNC &&
          (python_compat(contextptr) || !archive_function_index(*var._FUNCptr))) {
        newc1.push_back(var);
    ...
    for (size_t i = 0; i < newcsto.size(); ++i) {
      ...
      if (var.type == _FUNC && var != at_random &&
          (python_compat(contextptr) || !archive_function_index(*var._FUNCptr))) {
        newc1.push_back(var);
        newc2.push_back(identificateur(mkvalid(var._FUNCptr->ptr()->print(contextptr)) + "_rep"));
      }
    ...
    if (cloc) {
      ...
      if (clocg.type == _VECT && !clocg._VECTptr->empty()) {
        ...
        glob = clocg.type == _VECT && clocg._VECTptr->size() == 2 &&
               clocg._VECTptr->front().type == _VECT && clocg._VECTptr->front()._VECTptr->empty();
      }
    }
    if (python_compat(contextptr) && (!cloc || glob)) {
      ...
      if (!non_decl.empty()) {
        *logptr(contextptr) << gettext("Auto-declared local variables : ")
                            << gen(non_decl, _SEQ__VECT) << '\n';
        if (glob)
          newc = symb_local(makesequence(non_decl, clocg._VECTptr->back()),
                            newc._SYMBptr->feuille._VECTptr->back(), contextptr);
        else
    ...
    if (warn && newc.is_symb_of_sommet(at_local)) {
      ...
      if (newcf.type == _VECT && newcf._VECTptr->size() == 2) {
        ...
        if (inters.type == _VECT && !inters._VECTptr->empty()) {
          ...
          *logptr(contextptr) << gettext("Warning: Local variables shadow function arguments ")
                              << inters << '\n';
        }
      }
    }
  ...
  static bool is_return(const gen & g, gen & newres) {
    ...
    if ((g.type == _VECT && (g.subtype == _SEQ__VECT || g.subtype == _PRG__VECT) &&
         g._VECTptr->size() == 1))
  ...
  void adjust_sst_at(const gen & name, GIAC_CONTEXT) {
    ...
    const_iterateur it = debug_ptr(contextptr)->debug_breakpoint.begin(),
                    itend = debug_ptr(contextptr)->debug_breakpoint.end();
    for (; it != itend; ++it) {
  ...
  if (int(dbgptr->sst_at_stack.size()) >= MAX_RECURSION_LEVEL + 1) {
    ...
    if (values.type != _VECT || values.subtype != _SEQ__VECT ||
        (vars._VECTptr->size() == 1 && values._VECTptr->size() > 1))
        ...
        for (; !ctrl_c && !interrupted && it != itend; ++it) {
          ...
          if (!findlabel) {
            if (it->is_symb_of_sommet(at_return)) {
              if (!equaltosto(it->_SYMBptr->feuille, contextptr)
                       .in_eval(prog_eval_level(newcontextptr), newres, newcontextptr))
                newres = it->_SYMBptr->feuille;
              is_return(newres, res);
              break;
            }
            if (!equaltosto(*it, contextptr)
                     .in_eval(prog_eval_level(newcontextptr), res, newcontextptr))
              res = *it;
          } else
            res = *it;
  ...
  static define_unary_function_eval4_index(147, __program, &quote_program, _program_s,
                                           &printasprogram, &texprintasprogram);
  ...
  gen _bloc(const gen & prog, GIAC_CONTEXT) {
    if (prog.type == _STRNG && prog.subtype == -1)
      return prog;
    gen res, label;
  ...
  string printasifte(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    if (calc38 || xcas_mode(contextptr) > 0) {
      ...
      res += ") ";
    debug_ptr(contextptr)->indent_spaces += 2;
    if ((calc38 || xcas_mode(contextptr) > 0) && (it->type == _SYMB) &&
        (it->_SYMBptr->sommet == at_bloc))
    ...
    debug_ptr(contextptr)->indent_spaces -= 2;
    ++it;
    while ((calc38 || xcas_mode(contextptr) > 0) && (it->type == _SYMB) &&
           (it->_SYMBptr->sommet == at_ifte)) {
      if (xcas_mode(contextptr) == 3)
    ...
    if (!is_zero(*it)) {
      ...
      if ((calc38 || xcas_mode(contextptr) > 0) && (it->type == _SYMB) &&
        ...
        if (it->type == _SYMB &&
            (it->_SYMBptr->sommet == at_ifte || it->_SYMBptr->sommet == at_for)) {
          res += '{';
          res += it->print(contextptr);
          res += '}';
        } else {
  ...
  gen ifte(const gen & args, bool isifte, const context * contextptr) {
    ...
    if (test.type != _INT_) {
      ...
      if (!is_integer(test)) {
        test =
            test.type == _MAP ? !test._MAPptr->empty() : test.evalf_double(evallevel, contextptr);
  ...
  test = equaltosame(test.eval(eval_level(contextptr), contextptr))
             .eval(eval_level(contextptr), contextptr);
  if (!is_integer(test)) {
  ...
  gen _evalb(const gen & args, GIAC_CONTEXT) {
    if (args.type == _STRNG && args.subtype == -1)
      return args;
    if (args.type == _VECT)
      return apply(args, _evalb, contextptr);
  ...
  static string printaswhen(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
	...
	s +=","+v[2].print(contextptr);
      return s+"]";
#else
      string s = "when(" + v[0].print(contextptr) + "," + v[1].print(contextptr) + "," +
                 v[2].print(contextptr) + ")";
      return s;
#endif
    }
  ...
  gen _when(const gen & args, const context * contextptr) {
    ...
    if (v.size() == 3 || v.size() == 4) {
      ...
      if (conditional_symbolic_equal(v[0], condition, contextptr)) {
        if (is_one(condition))
          return v[1].eval(eval_level(contextptr), contextptr);
        if (v.size() == 4)
          return v[3];
  ...
  string printasfor(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    if (feuille._VECTptr->size() == 2)
      return feuille._VECTptr->front().print(contextptr) + " in " +
             feuille._VECTptr->back().print(contextptr);
    ...
    if (python) {
      ...
      if (inc.is_symb_of_sommet(at_sto) && inc._SYMBptr->feuille[1].type == _IDNT) {
        gen index = inc._SYMBptr->feuille[1];
        if (inc._SYMBptr->feuille[0] == index + 1 && it->is_symb_of_sommet(at_sto) &&
            it->_SYMBptr->feuille[1] == index) {
          gen start = it->_SYMBptr->feuille[0];
          if ((it + 1)->type == _SYMB &&
              ((it + 1)->_SYMBptr->sommet == at_inferieur_egal ||
               (it + 1)->_SYMBptr->sommet == at_inferieur_strict) &&
              (it + 1)->_SYMBptr->feuille[0] == index) {
    ...
    if (is_integer(*it) && is_integer(*(it + 2))) {
      ...
      bool dodone = false;
      if (it->is_symb_of_sommet(at_for) && it->_SYMBptr->feuille.type == _VECT &&
          it->_SYMBptr->feuille._VECTptr->size() == 2) {
        res = "for " + it->_SYMBptr->feuille._VECTptr->front().print(contextptr) + " in " +
              it->_SYMBptr->feuille._VECTptr->back().print(contextptr) + " do ";
        dodone = true;
      } else {
        if (maplemode > 0) {
          ...
          if (maplemode == 3)
            ...
            res = (maplemode == 4 ? "WHILE " : "while ") + sametoequal(*it).print(contextptr) +
                  (maplemode == 4 ? " DO" : " do ");
        } else
      ...
      ++it;
      debug_ptr(contextptr)->indent_spaces += 2;
      if ((maplemode > 0 || res.substr(res.size() - 3, 3) == "do ") && (it->type == _SYMB) &&
          (it->_SYMBptr->sommet == at_bloc))
        res += printasinnerbloc(it->_SYMBptr->feuille, contextptr) + ";";
      else
        res += it->print(contextptr) + ";";
      ...
      if (maplemode > 0) { // pb for generic loops for Maple translation
        gen inc = from_increment(*(it + 2));
        if ((it->type != _SYMB) || (it->_SYMBptr->sommet != at_sto) || (inc.type != _SYMB) ||
            inc._SYMBptr->sommet != at_sto ||
            (it->_SYMBptr->feuille._VECTptr->back() != inc._SYMBptr->feuille._VECTptr->back()))
        ...
        if (maplemode == 3) {
          ...
          if (!simple_loop)
            res += indent(contextptr) + "If not(" + (it + 1)->print(contextptr) + ")" +
                   indent(contextptr) + "Exit";
          res += indent(contextptr);
        } else {
          gen absstep = step;
          if (simple_loop) {
  ...
  static gen to_increment(const gen & g) {
    ...
    if (type && av.front() == b) {
      if (s == 2) {
        ...
        return symbolic(type == 1 ? at_increment : at_decrement,
                        gen(makevecteur(b, av.back()), _SEQ__VECT));
      }
      if (type)
        return symbolic(
            at_increment,
            gen(makevecteur(b, symbolic(at_plus, vecteur(av.begin() + 1, av.end()))), _SEQ__VECT));
    }
    return g;
  }
  ...
  static bool set_for_in(int counter, int for_in, vecteur * v, string * s, const gen & name,
                         GIAC_CONTEXT) {
  ...
  gen _for(const gen & args, const context * contextptr) {
    ...
    if ((initialisation.type == _SYMB) && (initialisation._SYMBptr->sommet == at_sto)) {
      ...
      if (variable.type == _IDNT) {
        if (contextptr == context0 &&
            (xcas_mode(contextptr) != 1 &&
             (!variable._IDNTptr->localvalue || variable._IDNTptr->localvalue->empty() ||
              (*variable._IDNTptr->localvalue)[variable._IDNTptr->localvalue->size() - 2].val <
                  protection_level - 1))) {
          bound = true;
    ...
    gen test = argsv[1];
    if (is_equal(test))
      test = symb_same(test._SYMBptr->feuille._VECTptr->front(),
                       test._SYMBptr->feuille._VECTptr->back());
    ...
    try {
      ...
      gen gforin;
      size_t testsize = 0;
      if ((test.is_symb_of_sommet(at_for) || test.is_symb_of_sommet(at_pour)) &&
          test._SYMBptr->feuille.type == _VECT &&
          (testsize = test._SYMBptr->feuille._VECTptr->size()) >= 2) {
      ...
      bool stdloop = (itend - it) < 5 && contextptr && !for_in && is_inequation(test) &&
                     test._SYMBptr->feuille.type == _VECT &&
                     test._SYMBptr->feuille._VECTptr->size() == 2 && !dbgptr->debug_mode;
      stdloop = stdloop && increment.type == _SYMB &&
                (increment._SYMBptr->sommet == at_increment ||
                 increment._SYMBptr->sommet == at_decrement);
      gen index, stopg;
      int *idx = 0, step, stop;
      if (stdloop) {
        index = increment._SYMBptr->feuille;
        if (index.type == _VECT)
          index = index._VECTptr->front();
      ...
      if (stdloop) {
        ...
        // compute idx
        if (it != itend && it->second.type == _INT_ && (stop - it->second.val) / step >= 5) {
          idx = &it->second.val;
...
#pragma clang diagnostic ignored "-Wunused-value"
             idx ? *idx != stop
                 : ((for_in && test.val)
                        ? set_for_in(counter, for_in, for_in_v, for_in_s, index_name, newcontextptr)
                        : for_test(test, testf, eval_lev, newcontextptr));
             ++counter,
             idx ? * idx += step
                 : ((test.val && increment.type) ? increment.eval(eval_lev, newcontextptr).val : 0)
#pragma clang diagnostic pop
  ...
  int giac_bind(const vecteur & vals_, const vecteur & vars_, context *& contextptr) {
    ...
    for (int i = 0; i < vals_.size(); ++i) {
      ...
      if (f.type != _VECT || f._VECTptr->size() != 2 || f._VECTptr->front().type != _IDNT)
        continue;
      gen var = f._VECTptr->front(), val = f._VECTptr->back();
      int j = 0;
      for (; j < vars.size(); ++j) {
        if (!vars[i].is_symb_of_sommet(at_equal))
          continue;
    ...
    for (int i = int(vars.size()) - 1; i >= 0; --i) {
      if (vars.size() <= vals.size())
        break;
      if (vars[i].is_symb_of_sommet(at_equal))
        vals.insert(vals.begin() + ins,
                    eval(vars[i]._SYMBptr->feuille[1], prog_eval_level(contextptr), contextptr));
      else {
        if (ins > 0)
          --ins;
      }
    ...
    for (; it != itend; ++it, ++jt) {
      if (jt->type == _SYMB) {
        if (jt->_SYMBptr->sommet == at_check_type) {
          ...
          if (is_undef(_check_type(makevecteur(jt->_SYMBptr->feuille._VECTptr->front(), *it),
                                   contextptr)))
            return -RAND_MAX;
        } else {
          if (jt->_SYMBptr->sommet == at_double_deux_points) {
            tmp = jt->_SYMBptr->feuille._VECTptr->front();
            if (is_undef(_check_type(makevecteur(jt->_SYMBptr->feuille._VECTptr->back(), *it),
                                     contextptr)))
              return -RAND_MAX;
          } else {
            if (jt->_SYMBptr->sommet == at_of) {
              tmp = jt->_SYMBptr->feuille._VECTptr->front();
              *logptr(contextptr) << gettext("Invalid variable ") + jt->print(contextptr) +
                                         gettext(" using ") + tmp.print(contextptr) +
                                         gettext(" instead.");
            } else
              tmp = *jt;
          }
            ...
            if (a.type == _DOUBLE_ && a._DOUBLE_val <= RAND_MAX && a._DOUBLE_val >= -RAND_MAX) {
              ...
              if (i != a._DOUBLE_val)
                *logptr(contextptr) << gettext("Converting ") << a._DOUBLE_val
                                    << gettext(" to integer ") << i << '\n';
              a = i;
            } else {
              if (a.type != _INT_) {
                if (a.type != _ZINT || mpz_sizeinbase(*a._ZINTptr, 2) > 62) {
                  *logptr(contextptr)
                      << gettext("Unable to convert to integer ") + a.print(contextptr) << '\n';
                  return -RAND_MAX;
                }
              }
            }
...
#ifdef DEBUG_SUPPORT
      if (tmp.type != _IDNT)
        setsizeerr(gettext("prog.cc/leave"));
#endif
  ...
  static string printaslocal(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    for (;;) {
      ...
      if (it == itend) {
        ...
        return res;
      } else if (xcas_mode(contextptr) != 3)
        res += "; ";
    }
  }
  ...
  gen _local(const gen & args, const context * contextptr) {
    ...
    for (; it != itend; ++it) {
...
#if 1
        gen err =
            string2gen(gettext("Uninitialized local variable ") + it->print(contextptr), false);
        err.subtype = -1;
      ...
      if ((it->type != _SYMB) ||
          (it->_SYMBptr->sommet != at_sto && it->_SYMBptr->sommet != at_equal))
        return gentypeerr(contextptr);
        ...
        for (; !ctrl_c && !interrupted && it != itend; ++it) {
          ...
          if (debug_ptr(newcontextptr)->debug_mode) {
            ...
            if (!is_undef(res)) {
              if (!findlabel) {
                if (!equaltosto(*it, contextptr)
                         .in_eval(eval_level(newcontextptr), res, newcontextptr))
                  res = *it;
              } else
                res = *it;
            }
  ...
  static string printasreturn(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    if (abs_calc_mode(contextptr) == 38 || (xcas_mode(contextptr) == 1) ||
        (xcas_mode(contextptr) == 1 + _DECALAGE))
...
#endif
    if (do_else_try) {
      if ((res.type == _SYMB && res._SYMBptr->sommet == at_return) ||
          (res.type == _FUNC && (res == at_return || res == at_break || res == at_continue)))
        ;
      else
  ...
  static define_unary_function_eval2_index(177, __try_catch, &_try_catch, _try_catch_s,
                                           &printastry_catch);
  ...
  gen subsop(const vecteur & g, const vecteur & v, const gen & sommet, GIAC_CONTEXT) {
    ...
    const_iterateur it = v.begin(), itend = v.end();
    for (; it != itend; ++it) {
      if ((!is_equal(*it) && !it->is_symb_of_sommet(at_same)) ||
      ...
      if (w.front().type == _VECT) {
        ...
        if (rec.size() == 1)
          ...
          if (rec.front().type != _INT_ || i < 0 || i >= signed(res.size()))
            return gendimerr(contextptr);
          if (is_undef((res[i] = subsop(
                            res[i],
                            vecteur(1, symbolic(at_equal,
                                                gen(makevecteur(vecteur(rec.begin() + 1, rec.end()),
                                                                w.back()),
                                                    _SEQ__VECT))),
                            contextptr))))
            return res[i];
  ...
  static define_unary_function_eval2(__maple_subsop, &_maple_subsop, _maple_subsop_s,
                                     &printasmaple_subs);
  ...
  gen _prepend(const gen & args, GIAC_CONTEXT) {
    if (args.type == _STRNG && args.subtype == -1)
      return args;
    if (args.type == _VECT && args._VECTptr->size() == 2 && args._VECTptr->front().type == _STRNG &&
        args._VECTptr->back().type == _STRNG)
  ...
  gen _is_included(const gen & args, GIAC_CONTEXT) {
    if (args.type == _STRNG && args.subtype == -1)
      return args;
    if ((args.type != _VECT) || (args._VECTptr->size() != 2) ||
        (args._VECTptr->front().type != _VECT) || (args._VECTptr->back().type != _VECT))
      return gensizeerr(contextptr);
  ...
  gen concat(const gen & g, bool glue_lines, GIAC_CONTEXT) {
    ...
    if (v0.type == _VECT && v1.type == _VECT) {
      if (!glue_lines && v1.subtype != _SEQ__VECT && ckmatrix(v0) && ckmatrix(v1) &&
  ...
  gen _extend(const gen & args, GIAC_CONTEXT) {
    ...
    if (args.type != _VECT || args._VECTptr->size() != 2 || args._VECTptr->front().type != _VECT ||
        args._VECTptr->back().type != _VECT)
      return gensizeerr(contextptr);
    return gen(mergevecteur(*args._VECTptr->front()._VECTptr, *args._VECTptr->back()._VECTptr),
               args._VECTptr->front().subtype);
  }
  ...
  static string printascase(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    if ((feuille.type != _VECT) || (feuille._VECTptr->size() != 2) ||
        (feuille._VECTptr->back().type != _VECT))
      return string(sommetstr) + ('(' + feuille.print(contextptr) + ')');
    string res("switch (");
    res += feuille._VECTptr->front().print(contextptr);
    res += "){";
    debug_ptr(contextptr)->indent_spaces += 2;
    const_iterateur it = feuille._VECTptr->back()._VECTptr->begin(),
                    itend = feuille._VECTptr->back()._VECTptr->end();
    for (; it != itend; ++it) {
      ++it;
      if (it == itend) {
  ...
  gen _case(const gen & args, GIAC_CONTEXT) { // FIXME DEBUGGER
    ...
    gen expr = args._VECTptr->front().eval(eval_level(contextptr), contextptr), res = undef, oldres,
        newres;
    const_iterateur it = args._VECTptr->back()._VECTptr->begin(),
                    itend = args._VECTptr->back()._VECTptr->end();
    for (; it != itend;) {
      if (it + 1 == itend) {
        res = it->eval(eval_level(contextptr), contextptr);
        break;
  ...
  static gen rand_integer_interval(const gen & x1, const gen & x2, GIAC_CONTEXT) {
    ...
    if (unsigned(rand_max2) == (1u << 31) - 1) {
      ...
      if (x1.type == _INT_) {
        if (x1.val > 0)
          mpz_add_ui(tmp, tmp, x1.val);
        else
          mpz_sub_ui(tmp, tmp, -x1.val);
      } else
  ...
  static gen rand_max_plus_one = gen(rand_max2) + 1;
    ...
    if ((x.type == _DOUBLE_) && (y.type == _DOUBLE_)) {
      ...
      double xr =
          (giac_rand(contextptr) / evalf_double(rand_max_plus_one, 1, contextptr)._DOUBLE_val) *
              (yd - xd) +
          xd;
      return xr;
    }
  ...
  gen _rand(const gen & args, GIAC_CONTEXT) {
    ...
    if (args.type == _INT_ && (argsval = args.val)) {
      ...
      global * ptr;
      int c;
      if (argsval > 0 && contextptr && (ptr = contextptr->globalptr) && ptr->_xcas_mode_ != 3 &&
          (c = ptr->_calc_mode_) != -38 && c != 38) {
...
#endif
      if (argsval < 0)
        return -(xcas_mode(contextptr) == 3) +
               int(argsval * (giac_rand(contextptr) / (rand_max2 + 1.0)));
      else
        return (xcas_mode(contextptr) == 3 || abs_calc_mode(contextptr) == 38) +
               int(argsval * (giac_rand(contextptr) / (rand_max2 + 1.0)));
    }
    if (args.type == _STRNG && args.subtype == -1)
      return args;
    ...
    if (nd && args.type == _SYMB) {
      ...
      if (nd == 2) {
        if (v.size() != 2 || !is_integral(v[0]) || v[0].type != _INT_ ||
            (v[1] = evalf_double(v[1], 1, contextptr)).type != _DOUBLE_)
          return gensizeerr(contextptr);
    ...
    if (args.type == _VECT) {
      ...
      if ((nd = is_distribution(v[0]))) {
        ...
        return _rand(v[0](gen(vecteur(v.begin() + 1, v.end()), _SEQ__VECT), contextptr),
                     contextptr);
      }
      if (s == 2) {
        if (v[0] == at_exp)
  ...
  gen _char(const gen & args_, GIAC_CONTEXT) {
    if (args_.type == _STRNG && args_.subtype == -1)
      return args_;
    string s;
    gen args(args_);
    if (is_integral(args)) {
  ...
  gen _asc(const gen & args, GIAC_CONTEXT) {
    ...
    if (args.type == _VECT) {
      if ((args._VECTptr->size() != 2) || (args._VECTptr->front().type != _STRNG) ||
  ...
  gen _map(const gen & args, const context * contextptr) {
    ...
    if (xcas_mode(contextptr) == 1 ||
        (to_map.type != _FUNC && !to_map.is_symb_of_sommet(at_program) &&
         (objet.type == _FUNC || objet.is_symb_of_sommet(at_program)))) {
      objet = v[1];
      to_map = v.front();
    }
    ...
    if (v.size() == 2) {
      ...
      if (objet.type == _POLY) {
        ...
        polynome res(dim);
        vector<monomial<gen>>::const_iterator it = objet._POLYptr->coord.begin(),
                                              itend = objet._POLYptr->coord.end();
  ...
  static define_unary_function_eval4_index(56, __interval, &_interval, _interval_s,
      ...
      if (real_interval * aptr = dynamic_cast<real_interval *>(a._REALptr)) {
        if (real_interval * bptr = dynamic_cast<real_interval *>(b._REALptr)) {
          ...
          if (contains(a, b))
            ...
            return _union(
                makesequence(a, eval(gen(makevecteur(b, b), _INTERVAL__VECT), 1, contextptr)),
                contextptr);
        }
      }
      if (contains(b, a))
        ...
        return _union(makesequence(b, eval(gen(makevecteur(a, a), _INTERVAL__VECT), 1, contextptr)),
                      contextptr);
    }
    if (a.type == _REAL) {
      if (contains(a, b))
        ...
        return _union(makesequence(a, eval(gen(makevecteur(b, b), _INTERVAL__VECT), 1, contextptr)),
                      contextptr);
    }
    if (b.type == _REAL) {
      if (contains(b, a))
  ...
  static define_unary_function_eval4_index(58, __union, &_union, _union_s, &printsommetasoperator,
  ...
  static define_unary_function_eval4_index(62, __intersect, &_intersect, _intersect_s,
                                           &printsommetasoperator, &texprintsommetasoperator);
  ...
  static define_unary_function_eval4_index(60, __minus, &_minus, _minus_s, &printsommetasoperator,
                                           &texprintsommetasoperator);
  ...
  static string printasdollar(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    if (s == 3)
      return v[0].print(contextptr) + sommetstr + v[1].print(contextptr) + " in " +
             v[2].print(contextptr);
  ...
  gen _dollar(const gen & args, GIAC_CONTEXT) {
    ...
    if (abs_calc_mode(contextptr) == 38) {
      ...
      if (args.type == _VECT && args._VECTptr->size() == 2 && args._VECTptr->back().type == _INT_ &&
          args._VECTptr->back().val > 0) {
        string s =
            args._VECTptr->front().print(contextptr) + "$" + print_INT_(args._VECTptr->back().val);
        identificateur cellule(s);
        return eval(cellule, 1, contextptr);
      }
    }
    ...
    if (b1.type == _VECT && b1.subtype == _SEQ__VECT && b1._VECTptr->size() == 2) {
      ...
      if (b.type == _VECT && b.subtype == _SEQ__VECT && b._VECTptr->size() == 2 &&
          b11.is_symb_of_sommet(at_equal) && b._VECTptr->front().is_symb_of_sommet(at_equal))
        b11 = symb_equal(b._VECTptr->front()[1], b11[2]);
      return _dollar(gen(makevecteur(a, b11, b1._VECTptr->back()), _SEQ__VECT), contextptr);
    }
    if (a.is_symb_of_sommet(at_interval) && a._SYMBptr->feuille.type == _VECT &&
    ...
    if (intervalle.type == _VECT) {
      ...
      for (; it != itend; ++it)
        res.push_back(
            eval(quotesubst(a, var, *it, contextptr), eval_level(contextptr), contextptr));
      return gen(res, _SEQ__VECT);
      // return gen(res,intervalle.subtype);
    }
    if ((intervalle.type == _SYMB) && (intervalle._SYMBptr->sommet == at_interval)) {
      gen c = intervalle._SYMBptr->feuille._VECTptr->front(),
          d = intervalle._SYMBptr->feuille._VECTptr->back();
      ...
      for (;; debut += step) {
        if (ck_is_strictly_greater(reverse ? fin : debut, reverse ? debut : fin, contextptr))
          break;
        res.push_back(
            eval(quotesubst(a, var, debut, contextptr), eval_level(contextptr), contextptr));
        if (debut == fin)
          break;
      }
      return gen(res, _SEQ__VECT);
  ...
  static define_unary_function_eval4_index(125, __dollar, &_dollar, _dollar_s, &printasdollar,
                                           &texprintasdollar);
  ...
  gen _makemat(const gen & args, const context * contextptr) {
    ...
    if ((intervalle1.type != _SYMB) || (intervalle1._SYMBptr->sommet != at_interval) ||
        (intervalle2.type != _SYMB) || (intervalle2._SYMBptr->sommet != at_interval))
      return gensizeerr(gettext("makemat"));
    intervalle1 = intervalle1._SYMBptr->feuille;
    intervalle2 = intervalle2._SYMBptr->feuille;
    if ((intervalle1.type != _VECT) || (intervalle1._VECTptr->size() != 2) ||
        (intervalle2.type != _VECT) || (intervalle2._VECTptr->size() != 2))
    ...
    if ((debut_i.type != _INT_) || (fin_i.type != _INT_) || (debut_j.type != _INT_) ||
        (fin_j.type != _INT_))
  ...
  gen _compose(const gen & args, GIAC_CONTEXT) {
    ...
    if (args.type == _VECT && args.subtype == _SEQ__VECT && args._VECTptr->size() == 2 &&
        args._VECTptr->back().type == _SPOL1) {
    ...
    if (args.type == _VECT && args.subtype == _SEQ__VECT && args._VECTptr->size() == 2) {
      gen g = args._VECTptr->front();
      gen s = args._VECTptr->back();
      if (g.type == _VECT && (g.subtype == _POLY1__VECT || s.type == _SPOL1 ||
                              (s.type == _VECT && s.subtype == _POLY1__VECT)))
  ...
  static define_unary_function_eval4(__compose, &_compose, _compose_s, &printsommetasoperator,
                                     &texprintsommetasoperator);
    ...
    if (args.type == _VECT && args.subtype == _SEQ__VECT && args._VECTptr->size() == 2) {
      ...
      if (expo.type == _INT_) {
        if (base.type == _SPOL1) {
          ...
          for (; n > 0; n /= 2) {
            if (n % 2)
              res = _compose(makesequence(res, s), contextptr);
        ...
        if (base.type == _VECT && base.subtype == _POLY1__VECT && expo.val >= 0) {
          ...
          for (; n > 0; n /= 2) {
            if (n % 2)
              res = horner(*res._VECTptr, s, contextptr);
  ...
  static define_unary_function_eval4(__composepow, &_composepow, _composepow_s,
                                     &printsommetasoperator, &texprintsommetasoperator);
  ...
  void lidnt(const gen & args, vecteur & res, bool with_at) {
    ...
    case _SYMB:
      ...
      if (args._SYMBptr->sommet == at_program && args._SYMBptr->feuille.type == _VECT &&
          args._SYMBptr->feuille._VECTptr->size() == 3) {
        lidnt(args._SYMBptr->feuille._VECTptr->front(), res, with_at);
        lidnt(args._SYMBptr->feuille._VECTptr->back(), res, with_at);
        return;
      }
      if (args._SYMBptr->sommet == at_pnt && args._SYMBptr->feuille.type == _VECT &&
          args._SYMBptr->feuille._VECTptr->size() == 3) {
        lidnt(args._SYMBptr->feuille._VECTptr->front(), res, with_at);
        lidnt((*args._SYMBptr->feuille._VECTptr)[1], res, with_at);
        return;
      }
      if ((args._SYMBptr->sommet == at_integrate || args._SYMBptr->sommet == at_int ||
           args._SYMBptr->sommet == at_sum) &&
          args._SYMBptr->feuille.type == _VECT && args._SYMBptr->feuille._VECTptr->size() == 4) {
        vecteur & v = *args._SYMBptr->feuille._VECTptr;
        vecteur w(1, v[1]);
        lidnt(v[0], w, with_at);
    ...
    if (args.type == _POINTER_ && args.subtype == _THREAD_POINTER) {
      ...
      if (cptr
        ...
        if (g.type == _VECT && g._VECTptr->size() == 2 &&
            g._VECTptr->front().is_symb_of_sommet(at_quote)) {
  ...
  static gen rmwatch(const gen & args, GIAC_CONTEXT) {
    ...
    if (pos) {
      debug_ptr(contextptr)
          ->debug_watch.erase(debug_ptr(contextptr)->debug_watch.begin() + pos - 1,
                              debug_ptr(contextptr)->debug_watch.begin() + pos);
      return debug_ptr(contextptr)->debug_watch;
    }
    return zero;
  }
  ...
  gen _breakpoint(const gen & args, GIAC_CONTEXT) {
    ...
    if (child_id && thread_eval_status(contextptr) != 1)
      return args;
    if ((args.type != _VECT) || (args._VECTptr->size() != 2) ||
        (args._VECTptr->front().type != _IDNT) || (args._VECTptr->back().type != _INT_))
      return zero;
    if (!equalposcomp(debug_ptr(contextptr)->debug_breakpoint, args)) {
      ...
      if (!debug_ptr(contextptr)->args_stack.empty() &&
          debug_ptr(contextptr)->args_stack.back().type == _VECT &&
          debug_ptr(contextptr)->args_stack.back()._VECTptr->front() == args._VECTptr->front())
  ...
  define_unary_function_ptr5(at_breakpoint, alias_at_breakpoint, &__breakpoint, _QUOTE_ARGUMENTS,
                             true);
  ...
  gen _rmbreakpoint(const gen & args, GIAC_CONTEXT) {
    ...
    if (pos) {
      debug_ptr(contextptr)
          ->debug_breakpoint.erase(debug_ptr(contextptr)->debug_breakpoint.begin() + pos - 1,
                                   debug_ptr(contextptr)->debug_breakpoint.begin() + pos);
      adjust_sst_at(*debug_ptr(contextptr)->debug_prog_name, contextptr);
      return debug_ptr(contextptr)->debug_breakpoint;
    }
    return zero;
  ...
  define_unary_function_ptr5(at_rmbreakpoint, alias_at_rmbreakpoint, &__rmbreakpoint,
                             _QUOTE_ARGUMENTS, true);

  void debug_loop(gen & res, GIAC_CONTEXT) {
    if (!debug_ptr(contextptr)->debug_allowed ||
        (!debug_ptr(contextptr)->sst_mode &&
         !equalposcomp(debug_ptr(contextptr)->sst_at, debug_ptr(contextptr)->current_instruction)))
      return;
    ...
    ws.push_back(cur);
      ...
      if (M - m < 5)
        m = giacmax(0, M - 5);
      for (int i = m; i <= M; ++i) {
        PrintMiniMini(&dispx, &dispy, (unsigned char *)(print_INT_(i) + ":" + ws[i]).c_str(),
                      (i == w[4].val ? 1 : 0), TEXT_COLOR_BLACK, 0);
    ...
    PrintMini(&dispx, &dispy, (unsigned char *)" next | stepin | cont. | kill |             ", 4,
              0xFFFFFFFF, 0, 0, COLOR_BLACK, COLOR_WHITE, 1, 0);
    w.push_back(dw);
    ...
    *dbgptr->debug_info_ptr = w;
    while (1) {
      ...
      if (i > 0) {
        ...
        evals = string("eval: ") + tmp.print(contextptr) + " => " +
                protecteval(tmp, 1, contextptr).print(contextptr) + '\n';
        cout << evals;
        iterateur it = dw.begin(), itend = dw.end();
        for (; it != itend; ++it) {
          evals += it->print(contextptr) + "=";
  ...
  static string printasdouble_deux_points(const gen & feuille, const char * sommetstr,
                                          GIAC_CONTEXT) {
    gen a, b;
...
#ifdef GIAC_HAS_STO_38
    return a.print(contextptr) +
           "::" + s; // removed final space, otherwise A::B::C adds a _ in prime + " ";
#else
  ...
  gen _double_deux_points(const gen & args, GIAC_CONTEXT) {
    ...
    if (b == at_revlist || b == at_reverse || b == at_sort || b == at_sorted || b == at_append ||
        b == at_prepend || b == at_concat || b == at_extend || b == at_rotate || b == at_shift ||
        b == at_suppress || b == at_clear) {
#if 1
    ...
    if (b.type == _SYMB) {
      ...
      if (c == at_index)
        return _struct_dot(eval(args, 1, contextptr), contextptr);
      if (c == at_revlist || c == at_reverse || c == at_sort || c == at_sorted || c == at_append ||
          c == at_prepend || c == at_concat || c == at_extend || c == at_rotate || c == at_shift ||
          c == at_suppress || c == at_clear) {
#if 1
        return _struct_dot(args, contextptr);
#else
      gen d = eval(a, eval_level(contextptr), contextptr);
      if (b._SYMBptr->feuille.type == _VECT && b._SYMBptr->feuille.subtype == _SEQ__VECT &&
          b._SYMBptr->feuille._VECTptr->empty())
        ;
      else
    ...
    if (storcl_38 && abs_calc_mode(contextptr) == 38 && a.type == _IDNT) {
      gen value;
      if (storcl_38(value, a._IDNTptr->id_name,
                    b.type == _IDNT ? b._IDNTptr->id_name : b.print().c_str(), undef, false,
                    contextptr, NULL, false)) {
        return value;
      }
    }
#ifndef RTOS_THREADX
    ...
    if (context_names) {
      map<string, context *>::iterator nt = context_names->find(a.print(contextptr)),
                                       ntend = context_names->end();
      if (nt != ntend) {
    ...
    */
    ...
    std::pair<charptr_gen *, charptr_gen *> p =
        equal_range(builtin_lexer_functions_begin(), builtin_lexer_functions_end(),
                    std::pair<const char *, gen>(cs.c_str(), 0), tri);
  ...
  static define_unary_function_eval2_index(91, __double_deux_points, &_double_deux_points,
                                           _double_deux_points_s, &printasdouble_deux_points);
  define_unary_function_ptr5(at_double_deux_points, alias_at_double_deux_points,
                             &__double_deux_points, _QUOTE_ARGUMENTS, 0);
  ...
  define_unary_function_ptr5(at_maple2mupad, alias_at_maple2mupad, &__maple2mupad, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_maple2xcas, alias_at_maple2xcas, &__maple2xcas, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_mupad2maple, alias_at_mupad2maple, &__mupad2maple, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_mupad2xcas, alias_at_mupad2xcas, &__mupad2xcas, _QUOTE_ARGUMENTS,
                             true);
  ...
  gen _javascript(const gen & args, GIAC_CONTEXT) {
    ...
    if (quickjs_ptr && args.type == _VECT && args._VECTptr->size() == 2) {
      ...
      if (a.type == _STRNG && b == at_javascript) {
        ...
        if (first_error_line(contextptr) > 0)
          g = string2gen(ans.empty() ? "Done" : ans, false);
#ifndef KHICAS
  ...
  define_unary_function_ptr5(at_javascript, alias_at_javascript, &__javascript, _QUOTE_ARGUMENTS,
                             true);

  static string printasvirgule(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    if ((feuille.type != _VECT) || (feuille._VECTptr->size() != 2))
      return string(sommetstr) + ('(' + feuille.print(contextptr) + ')');
    return feuille._VECTptr->front().print(contextptr) + ',' +
           feuille._VECTptr->back().print(contextptr);
  }
  ...
  static define_unary_function_eval2(__scientific_format, &_scientific_format, _scientific_format_s,
                                     &printasDigits);
  ...
  static define_unary_function_eval2(__integer_format, &_integer_format, _integer_format_s,
                                     &printasDigits);
  define_unary_function_ptr5(at_integer_format, alias_at_integer_format, &__integer_format, 0,
                             true);
  ...
  gen _xcas_mode(const gen & g, GIAC_CONTEXT) {
    ...
    return string2gen(gettext("Warning: some commands like subs might change arguments order"),
                      false);
  }
  ...
  static define_unary_function_eval2(__prog_eval_level, &_prog_eval_level, _prog_eval_level_s,
                                     &printasDigits);
  define_unary_function_ptr5(at_prog_eval_level, alias_at_prog_eval_level, &__prog_eval_level, 0,
                             true);
  ...
  static define_unary_function_eval2(__all_trig_solutions, &_all_trig_solutions,
                                     _all_trig_solutions_s, &printasDigits);
  define_unary_function_ptr(at_all_trig_solutions, alias_at_all_trig_solutions,
                            &__all_trig_solutions);
  ...
  static define_unary_function_eval2(__increasing_power, &_increasing_power, _increasing_power_s,
                                     &printasDigits);
  ...
  gen _ntl_on(const gen & g, GIAC_CONTEXT) {
    ...
    ntl_on((args.val) != 0,
           context0); // Current factorization routines do not have access to the context
    return args;
  }
  ...
  static define_unary_function_eval2(__complex_mode, &_complex_mode, _complex_mode_s,
                                     &printasDigits);
  ...
  define_unary_function_ptr5(at_convert_rootof, alias_at_convert_rootof, &__convert_rootof, 0,
                             true);
  ...
  static define_unary_function_eval2(__angle_radian, &_angle_radian, _angle_radian_s,
                                     &printasDigits);
  ...
  static define_unary_function_eval2(__proba_epsilon, &_proba_epsilon, _proba_epsilon_s,
                                     &printasDigits);
  ...
  static define_unary_function_eval2(__complex_variables, &_complex_variables, _complex_variables_s,
                                     &printasDigits);
  ...
  bool cas_setup(const vecteur & v_orig, GIAC_CONTEXT) {
    ...
    if (v[5].type == _VECT && v[5]._VECTptr->size() == 2 &&
        v[5]._VECTptr->front().type == _DOUBLE_ && v[5]._VECTptr->back().type == _DOUBLE_) {
  ...
  vecteur cas_setup(GIAC_CONTEXT) {
    ...
    v.push_back(
        an == 2
            ? 2
            : 1 - an); //grad //not sure if this will mess anything up on your side bernard, having int instead of bool
  ...
  gen _Digits(const gen & g, GIAC_CONTEXT) {
    ...
    bf_global_prec =
        (int(std::ceil(3.3219280948873623 * giacmax(absint(args.val), 1))) + 31) / 32 * 32;
  ...
  */
  ...
  gen simplifier(const gen & g, GIAC_CONTEXT) {
    ...
    return g;
#endif
    if (g.type != _SYMB || g._SYMBptr->sommet == at_program || g._SYMBptr->sommet == at_pnt ||
        g._SYMBptr->sommet == at_animation || g._SYMBptr->sommet == at_unit ||
        g._SYMBptr->sommet == at_integrate || g._SYMBptr->sommet == at_superieur_strict ||
        g._SYMBptr->sommet == at_superieur_egal || g._SYMBptr->sommet == at_inferieur_strict ||
        g._SYMBptr->sommet == at_inferieur_egal || g._SYMBptr->sommet == at_and ||
        g._SYMBptr->sommet == at_ou || g._SYMBptr->sommet == at_et ||
        g._SYMBptr->sommet == at_not || g._SYMBptr->sommet == at_xor ||
        g._SYMBptr->sommet == at_piecewise
#ifndef FXCG
    ...
    for (unsigned i = 0; i < w.size(); ++i) {
      ...
      if (wi.type == _SYMB) {
        ...
        if (wi.is_symb_of_sommet(at_pow) && f.type == _VECT && f._VECTptr->size() == 2 &&
            f._VECTptr->back().type == _FRAC) {
            ...
            if (pos) {
              if (0 && n == 1)
                ...
                if (d * f._VECTptr->back() == 1 && has_evalf(f0, fapprox, 1, contextptr))
                  ...
                  wi = b * pow(a, inv(d, contextptr), contextptr) *
                       pow(fast_divide_by_icontent(f0, z), f._VECTptr->back(), contextptr);
              }
              continue;
            }
          }
  ...
  static define_unary_function_eval(__inferieur_strict_sort, &_inferieur_strict_sort,
                                    _inferieur_strict_sort_s);
  define_unary_function_ptr5(at_inferieur_strict_sort, alias_at_inferieur_strict_sort,
                             &__inferieur_strict_sort, 0, true);
  ...
  gen continued_frac2gen(vector<int> v, double d_orig, double eps, GIAC_CONTEXT) {
    ...
    for (;;) {
      v.pop_back();
      if (v.empty()) {
        if (!my_isnan(d_orig) && fabs(evalf_double(res - d_orig, 1, contextptr)._DOUBLE_val) > eps)
          return d_orig;
        return res;
      }
  ...
  gen convert_interval(const gen & g, int nbits, GIAC_CONTEXT) {
    ...
    if (g.is_symb_of_sommet(at_rootof) && g._SYMBptr->feuille.type == _VECT &&
      ...
      if (p.type == _VECT && x.type == _VECT) {
        ...
        gen r = complexroot(makesequence(symb_horner(*x._VECTptr, vx_var),
                                         pow(plus_two, -nbits - nbitsmore - 4, contextptr)),
                            true, contextptr);
        if (r.type == _VECT) {
    ...
    if (g.type == _SYMB)
      return g._SYMBptr->sommet(convert_interval(g._SYMBptr->feuille, nbits, contextptr),
                                contextptr);
    if (g.type == _REAL) {
    ...
    if (g.type == _CPLX)
      return convert_interval(*g._CPLXptr, nbits, contextptr) +
             cst_i * convert_interval(*(g._CPLXptr + 1), nbits, contextptr);
    if (is_integer(g) || g.type == _REAL) {
      gen f = accurate_evalf(g, nbits);
      return eval(gen(makevecteur(f, f), _INTERVAL__VECT), 1, contextptr);
    }
    if (g.type == _FRAC) {
      return convert_interval(g._FRACptr->num, nbits, contextptr) /
             convert_interval(g._FRACptr->den, nbits, contextptr);
    }
    if (g.type == _IDNT) {
...
#endif
    return gensizeerr(
        "Interval arithmetic support not compiled. Please install MPFI and recompile");
  }
  ...
  gen convert_real(const gen & g, GIAC_CONTEXT) {
    ...
    if (g.type == _CPLX)
      return convert_real(*g._CPLXptr, contextptr) +
             cst_i * convert_real(*(g._CPLXptr + 1), contextptr);
    return g;
#endif
    return gensizeerr(
        "Interval arithmetic support not compiled. Please install MPFI and recompile");
  ...
  gen _convert(const gen & args, const context * contextptr) {
    ...
    vecteur v = *args._VECTptr;
    int s = int(v.size());
    if (s == 3 && v[0].type == _INT_ && v[0].subtype == _INT_PLOT && v[0].val == _AXES &&
        v[2].type == _INT_ && v[2].subtype == _INT_PLOT && v[2].val == _SET__VECT) {
    ...
    if (s >= 1 && v.front().type == _POLY) {
      ...
      vecteur idx(dim);
      vector<monomial<gen>>::const_iterator it = v.front()._POLYptr->coord.begin(),
                                            itend = v.front()._POLYptr->coord.end();
      vecteur res;
      res.reserve(itend - it);
      for (; it != itend; ++it) {
    ...
    if (s == 3 && f.type == _INT_) {
      ...
      if (f.val == _CONFRAC && v.back().type == _IDNT) {
        g = evalf_double(g, 1, contextptr);
        if (g.type == _DOUBLE_)
          return sto(vector_int_2_vecteur(float2continued_frac(g._DOUBLE_val, epsilon(contextptr))),
                     v.back(), contextptr);
      }
    }
    if (s > 2)
    ...
    if (f.type == _INT_ && f.val >= 0) {
      ...
      if (f.val == _POLY1__VECT && f.subtype == _INT_MAPLECONVERSION) { // remove order_size
        ...
        if (g.type == _VECT && !g._VECTptr->empty()) {
          ...
          if (w.front().type == _VECT && w.front()._VECTptr->size() == 2 &&
              w.front()._VECTptr->back().type == _VECT) {
  ...
  static define_unary_function_eval4(__deuxpoints, &_deuxpoints, _deuxpoints_s,
                                     &printsommetasoperator, &texprintsommetasoperator);
...
#ifdef NSPIRE
template <class T>
void in_mws_translate(ios_base<T> & inf, ios_base<T> & of)
#else
...
#ifdef NSPIRE
template <class T>
void mws_translate(ios_base<T> & inf, ios_base<T> & of)
#else
...
#endif
{
  ...
  while (!inf.eof()) {
    ...
    if (n1 > 7 && thet.substr(n1 - 7, 7) == "MPLTEXT") {
      ...
      if ((n1 > 4 && thet.substr(n1 - 4, 4) == "TEXT") ||
          (n1 > 7 && thet.substr(n1 - 7, 7) == "XPPEDIT")) {
        inf >> n1 >> n2;
        of << '"';
        in_mws_translate(inf, of);
        of << '"' << ";\n";
...
#ifdef NSPIRE
template <class T>
void ti_translate(ios_base<T> & inf, ios_base<T> & of)
#else
...
gen _read_nand(const gen & args, GIAC_CONTEXT) {
  ...
  if (args.type == _VECT && args._VECTptr->size() == 2 && args._VECTptr->back().type == _INT_) {
    ...
    for (int i = 0; i < n; ++i, addr += 4, dest += 4) {
      strncpy(buf, dest, 4);
      res.push_back(makevecteur((longlong)addr, int(*dest), int(*(dest + 1)), int(*(dest + 2)),
                                int(*(dest + 3)), string2gen(buf, false)));
    }
    free(dest - 4 * n);
    return res;
  }
...
define_unary_function_ptr5(at_save_history, alias_at_save_history, &__save_history, 0, true);
  ...
  */
  ...
  gen _findhelp(const gen & g, GIAC_CONTEXT) {
    ...
    if (args.type == _SYMB && args._SYMBptr->sommet == at_of &&
        args._SYMBptr->feuille.type == _VECT && args._SYMBptr->feuille._VECTptr->size() == 2) {
  ...
  gen _tablefunc(const gen & args, GIAC_CONTEXT) {
    ...
    gen graphe = symbolic(
        ...
        gen(makevecteur(_cell(makevecteur(vecteur(1, minus_one), vecteur(1, zero)), contextptr),
                        symb_equal(_cell(makevecteur(vecteur(1, minus_one), vecteur(1, minus_one)),
                                         contextptr),
                                   symb_interval(xstart, xmax))
#ifdef NUMWORKS
                            ,
    ...
    gen l31(_cell(makevecteur(vecteur(1, minus_one), vecteur(1, zero)), contextptr) +
            _cell(makevecteur(plus_one, vecteur(1, zero)), contextptr));
    l31.subtype = _SPREAD__SYMB;
    gen l32(symb_evalf(symbolic(
        at_subst,
        gen(makevecteur(_cell(makevecteur(zero, vecteur(1, zero)), contextptr),
                        _cell(makevecteur(zero, vecteur(1, minus_one)), contextptr),
                        _cell(makevecteur(vecteur(1, zero), vecteur(1, minus_one)), contextptr)),
            _SEQ__VECT))));
  ...
  gen _tableseq(const gen & args, GIAC_CONTEXT) {
    ...
    if (x.type != _VECT) {
      ...
      if (dim != 1)
        ...
        gen l31(symbolic(
            ...
            gen(makevecteur(
                    ...
                    symb_equal(
                        _cell(makevecteur(vecteur(1, -1), vecteur(1, zero)), contextptr),
                        makevecteur(
                            _cell(makevecteur(vecteur(1, plus_one), vecteur(1, zero)), contextptr),
                            xmin, xmax)),
      ...
      res.push_back(uzero);
      gen l51(symb_evalf(symbolic(
          at_subst,
          gen(makevecteur(_cell(makevecteur(zero, vecteur(1, zero)), contextptr),
                          _cell(makevecteur(plus_one, vecteur(1, zero)), contextptr),
                          _cell(makevecteur(vecteur(1, minus_one), vecteur(1, zero)), contextptr)),
              _SEQ__VECT))));
      ...
      gen l41(symb_eval(symbolic(
          at_subst,
          gen(makevecteur(_cell(makevecteur(zero, vecteur(1, zero)), contextptr), tmp1, tmp2),
              _SEQ__VECT))));
  ...
  gen protectevalorevalf(const gen & g, int level, bool approx, GIAC_CONTEXT) {
    ...
    if (cas_setup_save.size() > 5 && cas_setup_save[5].type == _VECT &&
        cas_setup_save[5]._VECTptr->size() == 2) {
  ...
  static define_unary_function_eval2(__nodisp, (const gen_op_context)_nodisp, _nodisp_s,
                                     &printasnodisp);
  ...
  static define_unary_function_eval2_index(106, __continue, &_continue, _continue_s,
                                           &printascontinue);
  ...
  */
  static string printastilocal(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    return string("(") + feuille._VECTptr->front().print(contextptr) + string("|") +
           feuille._VECTptr->back().print(contextptr) + ')';
  }
  gen _tilocal(const gen & args, const context * contextptr) {
    ...
    if (is_equal(v.front()))
      return symb_equal(
          _tilocal(makesequence((v.front()._SYMBptr->feuille)[0], v.back()), contextptr),
          _tilocal(makesequence((v.front()._SYMBptr->feuille)[1], v.back()), contextptr));
    ...
    for (; it != itend; ++it) {
      ...
      if (gf.type == _IDNT)
        vars.push_back(gf);
      if (gf.type == _SYMB && gf._SYMBptr->feuille.type == _VECT &&
          gf._SYMBptr->feuille._VECTptr->size() == 2 &&
          gf._SYMBptr->feuille._VECTptr->front().type == _IDNT)
        vars.push_back(gf._SYMBptr->feuille._VECTptr->front());
      if (it->type == _SYMB && it->_SYMBptr->sommet != at_superieur_strict &&
          it->_SYMBptr->sommet != at_superieur_egal &&
          it->_SYMBptr->sommet != at_inferieur_strict &&
          it->_SYMBptr->sommet != at_inferieur_egal && it->_SYMBptr->sommet != at_and)
    ...
    if (gv.type == _IDNT) {
      if (contextptr) {
        sym_tab::const_iterator it = contextptr->tabptr->find(gv._IDNTptr->id_name),
    ...
    */
    ...
    gen prg = symb_program(gen(vname, _SEQ__VECT), gen(v0, _SEQ__VECT),
                           symb_bloc(makevecteur(docond, gv)), contextptr);
    return prg(gen(v0, _SEQ__VECT), contextptr);
  }
  static const char _tilocal_s[] = "|";
  static define_unary_function_eval4_index(103, __tilocal, &_tilocal, _tilocal_s, &printastilocal,
                                           &texprintsommetasoperator);
  ...
  static string printasdialog(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    return "Dialog " + symbolic(at_bloc, feuille).print(contextptr) + indent(contextptr) +
           "EndDialog";
  }
  ...
  vecteur inputform_pre_analysis(const gen & g, GIAC_CONTEXT) {
    ...
    for (int i = 0; i < s; ++i) {
      ...
      if ((u == at_output) || (u == at_Text) || (u == at_Title) || (u == at_click) ||
          (u == at_Request) || (u == at_choosebox) || (u == at_DropDown) || (u == at_Popup) ||
          u == at_of || u == at_at)
        continue;
...
unary_function_eval __inputform(1, &_inputform, _inputform_s, &printasinputform);
#endif
  define_unary_function_ptr5(at_inputform, alias_at_inputform, &__inputform, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_choosebox, alias_at_choosebox, &__choosebox, _QUOTE_ARGUMENTS,
                             true);
    ...
    for (; it != itend; ++it) {
      if (it->type == _IDNT || it->is_symb_of_sommet(at_at) || it->is_symb_of_sommet(at_of)) {
        if (textinput)
          ...
          res =
              __click.op(makevecteur(string2gen(it->print(contextptr), false), 0, *it), contextptr);
      }
      if (it + 1 == itend)
        break;
      if (it->type == _STRNG && ((it + 1)->type == _IDNT || (it + 1)->is_symb_of_sommet(at_at) ||
                                 (it + 1)->is_symb_of_sommet(at_of))) {
        if (textinput)
  ...
  static define_unary_function_eval2_quoted(__DropDown, &_DropDown, _DropDown_s,
                                            &printastifunction);
  ...
  gen _expr(const gen & args, GIAC_CONTEXT) {
    ...
    if (args.type == _VECT && args._VECTptr->size() == 2 && args._VECTptr->front().type == _STRNG &&
      ...
      gen res = eval(gen(*args._VECTptr->front()._STRNGptr, contextptr), eval_level(contextptr),
                     contextptr);
    ...
    if (giac::first_error_line(contextptr))
      return gensizeerr(string(gettext("Syntax compatibility mode ")) +
                        print_program_syntax(xcas_mode(contextptr)) +
                        gettext(". Parse error line ") +
                        print_INT_(giac::first_error_line(contextptr)) + gettext(" column ") +
                        print_INT_(giac::lexer_column_number(contextptr)) + gettext(" at ") +
...
unary_function_eval __Col(0, &_Col, _Col_s, &printastifunction);
  ...
  gen matrix_apply(const gen & a, const gen & b, GIAC_CONTEXT,
                   gen (*f)(const gen &, const gen &, GIAC_CONTEXT)) {
    if (a.type != _VECT || b.type != _VECT || a._VECTptr->size() != b._VECTptr->size())
  ...
  static define_unary_function_eval4_index(92, __pointprod, &_pointprod, _pointprod_s,
                                           &printsommetasoperator, &texprintsommetasoperator);
  ...
  static define_unary_function_eval4_index(94, __pointdivision, &_pointdivision, _pointdivision_s,
                                           &printsommetasoperator, &texprintsommetasoperator);
  ...
  static define_unary_function_eval4_index(96, __pointpow, &_pointpow, _pointpow_s,
                                           &printsommetasoperator, &texprintsommetasoperator);
  ...
  static define_unary_function_eval2_index(100, __pourcent, &_pourcent, _pourcent_s,
                                           &printassuffix);
...
unary_function_eval __interactive(1, &_interactive, _interactive_s);
#endif
  define_unary_function_ptr5(at_interactive, alias_at_interactive, &__interactive, _QUOTE_ARGUMENTS,
                             true);
  ...
  static define_unary_function_eval4(__ti_semi, &_ti_semi, _ti_semi_s, &printsommetasoperator,
                                     &texprintsommetasoperator);
...
#if defined RTOS_THREADX || defined NSPIRE
  static define_unary_function_eval2_index(110, __maple_lib, &maple_lib, _maple_lib_s,
                                           &printasmaple_lib);
#else
...
std::map<const char *, const mksa_unit *, ltstr> & unit_conversion_map() {
  ...
  const identificateur & _IDNT_id_A_unit_rom =
      *(const identificateur *)&alias_identificateur_A_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_Angstrom_unit_rom = {0, 0, "_Angstrom", 0,
                                                                              0};
  const identificateur & _IDNT_id_Angstrom_unit_rom =
      *(const identificateur *)&alias_identificateur_Angstrom_unit_rom;
  ...
  const identificateur & _IDNT_id_Bq_unit_rom =
      *(const identificateur *)&alias_identificateur_Bq_unit_rom;
  ...
  const identificateur & _IDNT_id_yd_unit_rom =
      *(const identificateur *)&alias_identificateur_yd_unit_rom;
  ...
  const identificateur & _IDNT_id_yr_unit_rom =
      *(const identificateur *)&alias_identificateur_yr_unit_rom;
  ...
  const identificateur & _IDNT_id_Btu_unit_rom =
      *(const identificateur *)&alias_identificateur_Btu_unit_rom;
  ...
  const identificateur & _IDNT_id_R__unit_rom =
      *(const identificateur *)&alias_identificateur_R__unit_rom;
  ...
  static const alias_identificateur alias_identificateur_epsilon0__unit_rom = {0, 0, "_epsilon0_",
                                                                               0, 0};
  const identificateur & _IDNT_id_epsilon0__unit_rom =
      *(const identificateur *)&alias_identificateur_epsilon0__unit_rom;
  ...
  const identificateur & _IDNT_id_a0__unit_rom =
      *(const identificateur *)&alias_identificateur_a0__unit_rom;
  ...
  const identificateur & _IDNT_id_RSun__unit_rom =
      *(const identificateur *)&alias_identificateur_RSun__unit_rom;
  ...
  static const alias_identificateur alias_identificateur_REarth__unit_rom = {0, 0, "_REarth_", 0,
                                                                             0};
  const identificateur & _IDNT_id_REarth__unit_rom =
      *(const identificateur *)&alias_identificateur_REarth__unit_rom;
  ...
  const identificateur & _IDNT_id_Fdy_unit_rom =
      *(const identificateur *)&alias_identificateur_Fdy_unit_rom;
  ...
  const identificateur & _IDNT_id_F_unit_rom =
      *(const identificateur *)&alias_identificateur_F_unit_rom;
  ...
  const identificateur & _IDNT_id_FF_unit_rom =
      *(const identificateur *)&alias_identificateur_FF_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_Faraday__unit_rom = {0, 0, "_Faraday_", 0,
                                                                              0};
  const identificateur & _IDNT_id_Faraday__unit_rom =
      *(const identificateur *)&alias_identificateur_Faraday__unit_rom;
  ...
  const identificateur & _IDNT_id_G__unit_rom =
      *(const identificateur *)&alias_identificateur_G__unit_rom;
  ...
  const identificateur & _IDNT_id_Gal_unit_rom =
      *(const identificateur *)&alias_identificateur_Gal_unit_rom;
  ...
  const identificateur & _IDNT_id_Gy_unit_rom =
      *(const identificateur *)&alias_identificateur_Gy_unit_rom;
  ...
  const identificateur & _IDNT_id_H_unit_rom =
      *(const identificateur *)&alias_identificateur_H_unit_rom;
  ...
  const identificateur & _IDNT_id_HFCC_unit_rom =
      *(const identificateur *)&alias_identificateur_HFCC_unit_rom;
  ...
  const identificateur & _IDNT_id_Hz_unit_rom =
      *(const identificateur *)&alias_identificateur_Hz_unit_rom;
  ...
  const identificateur & _IDNT_id_IO__unit_rom =
      *(const identificateur *)&alias_identificateur_IO__unit_rom;
  ...
  const identificateur & _IDNT_id_J_unit_rom =
      *(const identificateur *)&alias_identificateur_J_unit_rom;
  ...
  const identificateur & _IDNT_id_K_unit_rom =
      *(const identificateur *)&alias_identificateur_K_unit_rom;
  ...
  const identificateur & _IDNT_id_L_unit_rom =
      *(const identificateur *)&alias_identificateur_L_unit_rom;
  ...
  const identificateur & _IDNT_id_N_unit_rom =
      *(const identificateur *)&alias_identificateur_N_unit_rom;
  ...
  const identificateur & _IDNT_id_NA__unit_rom =
      *(const identificateur *)&alias_identificateur_NA__unit_rom;
  ...
  const identificateur & _IDNT_id_Ohm_unit_rom =
      *(const identificateur *)&alias_identificateur_Ohm_unit_rom;
  ...
  const identificateur & _IDNT_id_P_unit_rom =
      *(const identificateur *)&alias_identificateur_P_unit_rom;
  ...
  const identificateur & _IDNT_id_PSun__unit_rom =
      *(const identificateur *)&alias_identificateur_PSun__unit_rom;
  ...
  const identificateur & _IDNT_id_Pa_unit_rom =
      *(const identificateur *)&alias_identificateur_Pa_unit_rom;
  ...
  const identificateur & _IDNT_id_R_unit_rom =
      *(const identificateur *)&alias_identificateur_R_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_Rankine_unit_rom = {0, 0, "_Rankine", 0,
                                                                             0};
  const identificateur & _IDNT_id_Rankine_unit_rom =
      *(const identificateur *)&alias_identificateur_Rankine_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_Rinfinity__unit_rom = {0, 0, "_Rinfinity_",
                                                                                0, 0};
  const identificateur & _IDNT_id_Rinfinity__unit_rom =
      *(const identificateur *)&alias_identificateur_Rinfinity__unit_rom;
  ...
  const identificateur & _IDNT_id_S_unit_rom =
      *(const identificateur *)&alias_identificateur_S_unit_rom;
  ...
  const identificateur & _IDNT_id_St_unit_rom =
      *(const identificateur *)&alias_identificateur_St_unit_rom;
  ...
  const identificateur & _IDNT_id_StdP__unit_rom =
      *(const identificateur *)&alias_identificateur_StdP__unit_rom;
  ...
  const identificateur & _IDNT_id_StdT__unit_rom =
      *(const identificateur *)&alias_identificateur_StdT__unit_rom;
  ...
  const identificateur & _IDNT_id_Sv_unit_rom =
      *(const identificateur *)&alias_identificateur_Sv_unit_rom;
  ...
  const identificateur & _IDNT_id_T_unit_rom =
      *(const identificateur *)&alias_identificateur_T_unit_rom;
  ...
  const identificateur & _IDNT_id_Torr_unit_rom =
      *(const identificateur *)&alias_identificateur_Torr_unit_rom;
  ...
  const identificateur & _IDNT_id_V_unit_rom =
      *(const identificateur *)&alias_identificateur_V_unit_rom;
  ...
  const identificateur & _IDNT_id_Vm__unit_rom =
      *(const identificateur *)&alias_identificateur_Vm__unit_rom;
  ...
  const identificateur & _IDNT_id_W_unit_rom =
      *(const identificateur *)&alias_identificateur_W_unit_rom;
  ...
  const identificateur & _IDNT_id_Wb_unit_rom =
      *(const identificateur *)&alias_identificateur_Wb_unit_rom;
  ...
  const identificateur & _IDNT_id_Wh_unit_rom =
      *(const identificateur *)&alias_identificateur_Wh_unit_rom;
  ...
  const identificateur & _IDNT_id_acre_unit_rom =
      *(const identificateur *)&alias_identificateur_acre_unit_rom;
  ...
  const identificateur & _IDNT_id_alpha__unit_rom =
      *(const identificateur *)&alias_identificateur_alpha__unit_rom;
  ...
  const identificateur & _IDNT_id_arcmin_unit_rom =
      *(const identificateur *)&alias_identificateur_arcmin_unit_rom;
  ...
  const identificateur & _IDNT_id_arcs_unit_rom =
      *(const identificateur *)&alias_identificateur_arcs_unit_rom;
  ...
  const identificateur & _IDNT_id_atm_unit_rom =
      *(const identificateur *)&alias_identificateur_atm_unit_rom;
  ...
  const identificateur & _IDNT_id_au_unit_rom =
      *(const identificateur *)&alias_identificateur_au_unit_rom;
  ...
  const identificateur & _IDNT_id_bar_unit_rom =
      *(const identificateur *)&alias_identificateur_bar_unit_rom;
  ...
  const identificateur & _IDNT_id_b_unit_rom =
      *(const identificateur *)&alias_identificateur_b_unit_rom;
  ...
  const identificateur & _IDNT_id_bbl_unit_rom =
      *(const identificateur *)&alias_identificateur_bbl_unit_rom;
  ...
  const identificateur & _IDNT_id_bblep_unit_rom =
      *(const identificateur *)&alias_identificateur_bblep_unit_rom;
  ...
  const identificateur & _IDNT_id_boe_unit_rom =
      *(const identificateur *)&alias_identificateur_boe_unit_rom;
  ...
  const identificateur & _IDNT_id_bu_unit_rom =
      *(const identificateur *)&alias_identificateur_bu_unit_rom;
  ...
  const identificateur & _IDNT_id_buUS_unit_rom =
      *(const identificateur *)&alias_identificateur_buUS_unit_rom;
  ...
  const identificateur & _IDNT_id_c3__unit_rom =
      *(const identificateur *)&alias_identificateur_c3__unit_rom;
  ...
  const identificateur & _IDNT_id_c__unit_rom =
      *(const identificateur *)&alias_identificateur_c__unit_rom;
  ...
  const identificateur & _IDNT_id_cal_unit_rom =
      *(const identificateur *)&alias_identificateur_cal_unit_rom;
  ...
  const identificateur & _IDNT_id_cd_unit_rom =
      *(const identificateur *)&alias_identificateur_cd_unit_rom;
  ...
  const identificateur & _IDNT_id_cf_unit_rom =
      *(const identificateur *)&alias_identificateur_cf_unit_rom;
  ...
  const identificateur & _IDNT_id_chain_unit_rom =
      *(const identificateur *)&alias_identificateur_chain_unit_rom;
  ...
  const identificateur & _IDNT_id_ct_unit_rom =
      *(const identificateur *)&alias_identificateur_ct_unit_rom;
  ...
  const identificateur & _IDNT_id_cu_unit_rom =
      *(const identificateur *)&alias_identificateur_cu_unit_rom;
  ...
  const identificateur & _IDNT_id_d_unit_rom =
      *(const identificateur *)&alias_identificateur_d_unit_rom;
  ...
  const identificateur & _IDNT_id_dB_unit_rom =
      *(const identificateur *)&alias_identificateur_dB_unit_rom;
  ...
  const identificateur & _IDNT_id_deg_unit_rom =
      *(const identificateur *)&alias_identificateur_deg_unit_rom;
  ...
  const identificateur & _IDNT_id_dyn_unit_rom =
      *(const identificateur *)&alias_identificateur_dyn_unit_rom;
  ...
  const identificateur & _IDNT_id_eV_unit_rom =
      *(const identificateur *)&alias_identificateur_eV_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_epsilon0q__unit_rom = {0, 0, "_epsilon0q_",
                                                                                0, 0};
  const identificateur & _IDNT_id_epsilon0q__unit_rom =
      *(const identificateur *)&alias_identificateur_epsilon0q__unit_rom;
  ...
  static const alias_identificateur alias_identificateur_epsilonox__unit_rom = {0, 0, "_epsilonox",
                                                                                0, 0};
  const identificateur & _IDNT_id_epsilonox__unit_rom =
      *(const identificateur *)&alias_identificateur_epsilonox__unit_rom;
  ...
  static const alias_identificateur alias_identificateur_epsilonsi__unit_rom = {0, 0, "_epsilonsi_",
                                                                                0, 0};
  const identificateur & _IDNT_id_epsilonsi__unit_rom =
      *(const identificateur *)&alias_identificateur_epsilonsi__unit_rom;
  ...
  const identificateur & _IDNT_id_erg_unit_rom =
      *(const identificateur *)&alias_identificateur_erg_unit_rom;
  ...
  const identificateur & _IDNT_id_f0__unit_rom =
      *(const identificateur *)&alias_identificateur_f0__unit_rom;
  ...
  const identificateur & _IDNT_id_fath_unit_rom =
      *(const identificateur *)&alias_identificateur_fath_unit_rom;
  ...
  const identificateur & _IDNT_id_fbm_unit_rom =
      *(const identificateur *)&alias_identificateur_fbm_unit_rom;
  ...
  const identificateur & _IDNT_id_fc_unit_rom =
      *(const identificateur *)&alias_identificateur_fc_unit_rom;
  ...
  const identificateur & _IDNT_id_fermi_unit_rom =
      *(const identificateur *)&alias_identificateur_fermi_unit_rom;
  ...
  const identificateur & _IDNT_id_flam_unit_rom =
      *(const identificateur *)&alias_identificateur_flam_unit_rom;
  ...
  const identificateur & _IDNT_id_fm_unit_rom =
      *(const identificateur *)&alias_identificateur_fm_unit_rom;
  ...
  const identificateur & _IDNT_id_ft_unit_rom =
      *(const identificateur *)&alias_identificateur_ft_unit_rom;
  ...
  const identificateur & _IDNT_id_ftUS_unit_rom =
      *(const identificateur *)&alias_identificateur_ftUS_unit_rom;
  ...
  const identificateur & _IDNT_id_g_unit_rom =
      *(const identificateur *)&alias_identificateur_g_unit_rom;
  ...
  const identificateur & _IDNT_id_galC_unit_rom =
      *(const identificateur *)&alias_identificateur_galC_unit_rom;
  ...
  const identificateur & _IDNT_id_galUK_unit_rom =
      *(const identificateur *)&alias_identificateur_galUK_unit_rom;
  ...
  const identificateur & _IDNT_id_galUS_unit_rom =
      *(const identificateur *)&alias_identificateur_galUS_unit_rom;
  ...
  const identificateur & _IDNT_id_gf_unit_rom =
      *(const identificateur *)&alias_identificateur_gf_unit_rom;
  ...
  const identificateur & _IDNT_id_gmol_unit_rom =
      *(const identificateur *)&alias_identificateur_gmol_unit_rom;
  ...
  const identificateur & _IDNT_id_gon_unit_rom =
      *(const identificateur *)&alias_identificateur_gon_unit_rom;
  ...
  const identificateur & _IDNT_id_grad_unit_rom =
      *(const identificateur *)&alias_identificateur_grad_unit_rom;
  ...
  const identificateur & _IDNT_id_grain_unit_rom =
      *(const identificateur *)&alias_identificateur_grain_unit_rom;
  ...
  const identificateur & _IDNT_id_h__unit_rom =
      *(const identificateur *)&alias_identificateur_h__unit_rom;
  ...
  const identificateur & _IDNT_id_ha_unit_rom =
      *(const identificateur *)&alias_identificateur_ha_unit_rom;
  ...
  const identificateur & _IDNT_id_hbar__unit_rom =
      *(const identificateur *)&alias_identificateur_hbar__unit_rom;
  ...
  const identificateur & _IDNT_id_hp_unit_rom =
      *(const identificateur *)&alias_identificateur_hp_unit_rom;
  ...
  const identificateur & _IDNT_id_inH2O_unit_rom =
      *(const identificateur *)&alias_identificateur_inH2O_unit_rom;
  ...
  const identificateur & _IDNT_id_inHg_unit_rom =
      *(const identificateur *)&alias_identificateur_inHg_unit_rom;
  ...
  const identificateur & _IDNT_id_inch_unit_rom =
      *(const identificateur *)&alias_identificateur_inch_unit_rom;
  ...
  const identificateur & _IDNT_id_k__unit_rom =
      *(const identificateur *)&alias_identificateur_k__unit_rom;
  ...
  const identificateur & _IDNT_id_kip_unit_rom =
      *(const identificateur *)&alias_identificateur_kip_unit_rom;
  ...
  const identificateur & _IDNT_id_knot_unit_rom =
      *(const identificateur *)&alias_identificateur_knot_unit_rom;
  ...
  const identificateur & _IDNT_id_kph_unit_rom =
      *(const identificateur *)&alias_identificateur_kph_unit_rom;
  ...
  const identificateur & _IDNT_id_kq__unit_rom =
      *(const identificateur *)&alias_identificateur_kq__unit_rom;
  ...
  const identificateur & _IDNT_id_lam_unit_rom =
      *(const identificateur *)&alias_identificateur_lam_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_lambda0_unit_rom = {0, 0, "_lambda0", 0,
                                                                             0};
  const identificateur & _IDNT_id_lambda0_unit_rom =
      *(const identificateur *)&alias_identificateur_lambda0_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_lambdac__unit_rom = {0, 0, "_lambdac_", 0,
                                                                              0};
  const identificateur & _IDNT_id_lambdac__unit_rom =
      *(const identificateur *)&alias_identificateur_lambdac__unit_rom;
  ...
  const identificateur & _IDNT_id_lb_unit_rom =
      *(const identificateur *)&alias_identificateur_lb_unit_rom;
  ...
  const identificateur & _IDNT_id_lbf_unit_rom =
      *(const identificateur *)&alias_identificateur_lbf_unit_rom;
  ...
  const identificateur & _IDNT_id_lbmol_unit_rom =
      *(const identificateur *)&alias_identificateur_lbmol_unit_rom;
  ...
  const identificateur & _IDNT_id_lbt_unit_rom =
      *(const identificateur *)&alias_identificateur_lbt_unit_rom;
  ...
  const identificateur & _IDNT_id_lep_unit_rom =
      *(const identificateur *)&alias_identificateur_lep_unit_rom;
  ...
  const identificateur & _IDNT_id_liqpt_unit_rom =
      *(const identificateur *)&alias_identificateur_liqpt_unit_rom;
  ...
  const identificateur & _IDNT_id_lyr_unit_rom =
      *(const identificateur *)&alias_identificateur_lyr_unit_rom;
  ...
  const identificateur & _IDNT_id_m_unit_rom =
      *(const identificateur *)&alias_identificateur_m_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_mEarth__unit_rom = {0, 0, "_mEarth_", 0,
                                                                             0};
  const identificateur & _IDNT_id_mEarth__unit_rom =
      *(const identificateur *)&alias_identificateur_mEarth__unit_rom;
  ...
  const identificateur & _IDNT_id_mSun__unit_rom =
      *(const identificateur *)&alias_identificateur_mSun__unit_rom;
  ...
  const identificateur & _IDNT_id_me__unit_rom =
      *(const identificateur *)&alias_identificateur_me__unit_rom;
  ...
  const identificateur & _IDNT_id_mho_unit_rom =
      *(const identificateur *)&alias_identificateur_mho_unit_rom;
  ...
  const identificateur & _IDNT_id_mi_unit_rom =
      *(const identificateur *)&alias_identificateur_mi_unit_rom;
  ...
  const identificateur & _IDNT_id_miUS_unit_rom =
      *(const identificateur *)&alias_identificateur_miUS_unit_rom;
  ...
  const identificateur & _IDNT_id_mil_unit_rom =
      *(const identificateur *)&alias_identificateur_mil_unit_rom;
  ...
  const identificateur & _IDNT_id_mile_unit_rom =
      *(const identificateur *)&alias_identificateur_mile_unit_rom;
  ...
  const identificateur & _IDNT_id_mille_unit_rom =
      *(const identificateur *)&alias_identificateur_mille_unit_rom;
  ...
  const identificateur & _IDNT_id_min_unit_rom =
      *(const identificateur *)&alias_identificateur_min_unit_rom;
  ...
  const identificateur & _IDNT_id_mmHg_unit_rom =
      *(const identificateur *)&alias_identificateur_mmHg_unit_rom;
  ...
  const identificateur & _IDNT_id_mn_unit_rom =
      *(const identificateur *)&alias_identificateur_mn_unit_rom;
  ...
  const identificateur & _IDNT_id_mol_unit_rom =
      *(const identificateur *)&alias_identificateur_mol_unit_rom;
  ...
  const identificateur & _IDNT_id_molK_unit_rom =
      *(const identificateur *)&alias_identificateur_molK_unit_rom;
  ...
  const identificateur & _IDNT_id_mp__unit_rom =
      *(const identificateur *)&alias_identificateur_mp__unit_rom;
  ...
  const identificateur & _IDNT_id_mph_unit_rom =
      *(const identificateur *)&alias_identificateur_mph_unit_rom;
  ...
  const identificateur & _IDNT_id_mpme__unit_rom =
      *(const identificateur *)&alias_identificateur_mpme__unit_rom;
  ...
  const identificateur & _IDNT_id_mu0__unit_rom =
      *(const identificateur *)&alias_identificateur_mu0__unit_rom;
  ...
  const identificateur & _IDNT_id_muB__unit_rom =
      *(const identificateur *)&alias_identificateur_muB__unit_rom;
  ...
  const identificateur & _IDNT_id_muN__unit_rom =
      *(const identificateur *)&alias_identificateur_muN__unit_rom;
  ...
  const identificateur & _IDNT_id_nmi_unit_rom =
      *(const identificateur *)&alias_identificateur_nmi_unit_rom;
  ...
  const identificateur & _IDNT_id_oz_unit_rom =
      *(const identificateur *)&alias_identificateur_oz_unit_rom;
  ...
  const identificateur & _IDNT_id_ozUK_unit_rom =
      *(const identificateur *)&alias_identificateur_ozUK_unit_rom;
  ...
  const identificateur & _IDNT_id_ozfl_unit_rom =
      *(const identificateur *)&alias_identificateur_ozfl_unit_rom;
  ...
  const identificateur & _IDNT_id_ozt_unit_rom =
      *(const identificateur *)&alias_identificateur_ozt_unit_rom;
  ...
  const identificateur & _IDNT_id_pc_unit_rom =
      *(const identificateur *)&alias_identificateur_pc_unit_rom;
  ...
  const identificateur & _IDNT_id_pdl_unit_rom =
      *(const identificateur *)&alias_identificateur_pdl_unit_rom;
  ...
  const identificateur & _IDNT_id_phi__unit_rom =
      *(const identificateur *)&alias_identificateur_phi__unit_rom;
  ...
  const identificateur & _IDNT_id_pk_unit_rom =
      *(const identificateur *)&alias_identificateur_pk_unit_rom;
  ...
  const identificateur & _IDNT_id_psi_unit_rom =
      *(const identificateur *)&alias_identificateur_psi_unit_rom;
  ...
  const identificateur & _IDNT_id_pt_unit_rom =
      *(const identificateur *)&alias_identificateur_pt_unit_rom;
  ...
  const identificateur & _IDNT_id_ptUK_unit_rom =
      *(const identificateur *)&alias_identificateur_ptUK_unit_rom;
  ...
  const identificateur & _IDNT_id_qe_unit_rom =
      *(const identificateur *)&alias_identificateur_qe_unit_rom;
  ...
  static const alias_identificateur alias_identificateur_qepsilon0__unit_rom = {0, 0, "_qepsilon0_",
                                                                                0, 0};
  const identificateur & _IDNT_id_qepsilon0__unit_rom =
      *(const identificateur *)&alias_identificateur_qepsilon0__unit_rom;
  ...
  const identificateur & _IDNT_id_qme__unit_rom =
      *(const identificateur *)&alias_identificateur_qme__unit_rom;
  ...
  const identificateur & _IDNT_id_qt_unit_rom =
      *(const identificateur *)&alias_identificateur_qt_unit_rom;
  ...
  const identificateur & _IDNT_id_rad_unit_rom =
      *(const identificateur *)&alias_identificateur_rad_unit_rom;
  ...
  const identificateur & _IDNT_id_rd_unit_rom =
      *(const identificateur *)&alias_identificateur_rd_unit_rom;
  ...
  const identificateur & _IDNT_id_rem_unit_rom =
      *(const identificateur *)&alias_identificateur_rem_unit_rom;
  ...
  const identificateur & _IDNT_id_rev_unit_rom =
      *(const identificateur *)&alias_identificateur_rev_unit_rom;
  ...
  const identificateur & _IDNT_id_rod_unit_rom =
      *(const identificateur *)&alias_identificateur_rod_unit_rom;
  ...
  const identificateur & _IDNT_id_rpm_unit_rom =
      *(const identificateur *)&alias_identificateur_rpm_unit_rom;
  ...
  const identificateur & _IDNT_id_sb_unit_rom =
      *(const identificateur *)&alias_identificateur_sb_unit_rom;
  ...
  const identificateur & _IDNT_id_sd_unit_rom =
      *(const identificateur *)&alias_identificateur_sd_unit_rom;
  ...
  const identificateur & _IDNT_id_sigma_unit_rom =
      *(const identificateur *)&alias_identificateur_sigma_unit_rom;
  ...
  const identificateur & _IDNT_id_slug_unit_rom =
      *(const identificateur *)&alias_identificateur_slug_unit_rom;
  ...
  const identificateur & _IDNT_id_syr__unit_rom =
      *(const identificateur *)&alias_identificateur_syr__unit_rom;
  ...
  const identificateur & _IDNT_id_tbsp_unit_rom =
      *(const identificateur *)&alias_identificateur_tbsp_unit_rom;
  ...
  const identificateur & _IDNT_id_tec_unit_rom =
      *(const identificateur *)&alias_identificateur_tec_unit_rom;
  ...
  const identificateur & _IDNT_id_tep_unit_rom =
      *(const identificateur *)&alias_identificateur_tep_unit_rom;
  ...
  const identificateur & _IDNT_id_tepC_unit_rom =
      *(const identificateur *)&alias_identificateur_tepC_unit_rom;
  ...
  const identificateur & _IDNT_id_tepcC_unit_rom =
      *(const identificateur *)&alias_identificateur_tepcC_unit_rom;
  ...
  const identificateur & _IDNT_id_tepgC_unit_rom =
      *(const identificateur *)&alias_identificateur_tepgC_unit_rom;
  ...
  const identificateur & _IDNT_id_tex_unit_rom =
      *(const identificateur *)&alias_identificateur_tex_unit_rom;
  ...
  const identificateur & _IDNT_id_therm_unit_rom =
      *(const identificateur *)&alias_identificateur_therm_unit_rom;
  ...
  const identificateur & _IDNT_id_toe_unit_rom =
      *(const identificateur *)&alias_identificateur_toe_unit_rom;
  ...
  const identificateur & _IDNT_id_ton_unit_rom =
      *(const identificateur *)&alias_identificateur_ton_unit_rom;
  ...
  const identificateur & _IDNT_id_tonUK_unit_rom =
      *(const identificateur *)&alias_identificateur_tonUK_unit_rom;
  ...
  const identificateur & _IDNT_id_tr_unit_rom =
      *(const identificateur *)&alias_identificateur_tr_unit_rom;
  ...
  const identificateur & _IDNT_id_tsp_unit_rom =
      *(const identificateur *)&alias_identificateur_tsp_unit_rom;
  ...
  const identificateur & _IDNT_id_u_unit_rom =
      *(const identificateur *)&alias_identificateur_u_unit_rom;
  ...
  const identificateur & _IDNT_id_E_unit_rom =
      *(const identificateur *)&alias_identificateur_E_unit_rom;
  ...
  const identificateur & _IDNT_id_Curie_unit_rom =
      *(const identificateur *)&alias_identificateur_Curie_unit_rom;
  ...
  const identificateur & _IDNT_id_C_unit_rom =
      *(const identificateur *)&alias_identificateur_C_unit_rom;
  ...
  const identificateur & _IDNT_id_kg_unit_rom =
      *(const identificateur *)&alias_identificateur_kg_unit_rom;
...
gen Angstrom_unit_rom_IDNT_e(Angstrom_unit_rom_IDNT);
  ...
  const gen * const tab_unit_rom[] = {
      &A_unit_rom_IDNT_e,          &Angstrom_unit_rom_IDNT_e,   &Bq_unit_rom_IDNT_e,
      &Btu_unit_rom_IDNT_e,        &C_unit_rom_IDNT_e,          &Curie_unit_rom_IDNT_e,
      &E_unit_rom_IDNT_e,          &F_unit_rom_IDNT_e,          &FF_unit_rom_IDNT_e,
      &Faraday__unit_rom_IDNT_e,   &Fdy_unit_rom_IDNT_e,        &G__unit_rom_IDNT_e,
      &Gal_unit_rom_IDNT_e,        &Gy_unit_rom_IDNT_e,         &H_unit_rom_IDNT_e,
      &HFCC_unit_rom_IDNT_e,       &Hz_unit_rom_IDNT_e,         &IO__unit_rom_IDNT_e,
      &J_unit_rom_IDNT_e,          &K_unit_rom_IDNT_e,          &L_unit_rom_IDNT_e,
      &N_unit_rom_IDNT_e,          &NA__unit_rom_IDNT_e,        &Ohm_unit_rom_IDNT_e,
      &P_unit_rom_IDNT_e,          &PSun__unit_rom_IDNT_e,      &Pa_unit_rom_IDNT_e,
      &R_unit_rom_IDNT_e,          &REarth__unit_rom_IDNT_e,    &RSun__unit_rom_IDNT_e,
      &R__unit_rom_IDNT_e,         &Rankine_unit_rom_IDNT_e,    &Rinfinity__unit_rom_IDNT_e,
      &S_unit_rom_IDNT_e,          &St_unit_rom_IDNT_e,         &StdP__unit_rom_IDNT_e,
      &StdT__unit_rom_IDNT_e,      &Sv_unit_rom_IDNT_e,         &T_unit_rom_IDNT_e,
      &Torr_unit_rom_IDNT_e,       &V_unit_rom_IDNT_e,          &Vm__unit_rom_IDNT_e,
      &W_unit_rom_IDNT_e,          &Wb_unit_rom_IDNT_e,         &Wh_unit_rom_IDNT_e,
      &a_unit_rom_IDNT_e,          &a0__unit_rom_IDNT_e,        &acre_unit_rom_IDNT_e,
      &alpha__unit_rom_IDNT_e,     &arcmin_unit_rom_IDNT_e,     &arcs_unit_rom_IDNT_e,
      &atm_unit_rom_IDNT_e,        &au_unit_rom_IDNT_e,         &b_unit_rom_IDNT_e,
      &bar_unit_rom_IDNT_e,        &bbl_unit_rom_IDNT_e,        &bblep_unit_rom_IDNT_e,
      &boe_unit_rom_IDNT_e,        &bu_unit_rom_IDNT_e,         &buUS_unit_rom_IDNT_e,
      &c3__unit_rom_IDNT_e,        &c__unit_rom_IDNT_e,         &cal_unit_rom_IDNT_e,
      &cd_unit_rom_IDNT_e,         &cf_unit_rom_IDNT_e,         &chain_unit_rom_IDNT_e,
      &ct_unit_rom_IDNT_e,         &cu_unit_rom_IDNT_e,         &d_unit_rom_IDNT_e,
      &dB_unit_rom_IDNT_e,         &deg_unit_rom_IDNT_e,        &dyn_unit_rom_IDNT_e,
      &eV_unit_rom_IDNT_e,         &epsilon0__unit_rom_IDNT_e,  &epsilon0q__unit_rom_IDNT_e,
      &epsilonox__unit_rom_IDNT_e, &epsilonsi__unit_rom_IDNT_e, &erg_unit_rom_IDNT_e,
      &f0__unit_rom_IDNT_e,        &fath_unit_rom_IDNT_e,       &fbm_unit_rom_IDNT_e,
      &fc_unit_rom_IDNT_e,         &fermi_unit_rom_IDNT_e,      &flam_unit_rom_IDNT_e,
      &fm_unit_rom_IDNT_e,         &ft_unit_rom_IDNT_e,         &ftUS_unit_rom_IDNT_e,
      &g_unit_rom_IDNT_e,          &g__unit_rom_IDNT_e,         &galC_unit_rom_IDNT_e,
      &galUK_unit_rom_IDNT_e,      &galUS_unit_rom_IDNT_e,      &gf_unit_rom_IDNT_e,
      &gmol_unit_rom_IDNT_e,       &gon_unit_rom_IDNT_e,        &grad_unit_rom_IDNT_e,
      &grain_unit_rom_IDNT_e,      &h_unit_rom_IDNT_e,          &h__unit_rom_IDNT_e,
      &ha_unit_rom_IDNT_e,         &hbar__unit_rom_IDNT_e,      &hp_unit_rom_IDNT_e,
      &inH2O_unit_rom_IDNT_e,      &inHg_unit_rom_IDNT_e,       &inch_unit_rom_IDNT_e,
      &j_unit_rom_IDNT_e,          &k__unit_rom_IDNT_e,         &kg_unit_rom_IDNT_e,
      &kip_unit_rom_IDNT_e,        &knot_unit_rom_IDNT_e,       &kph_unit_rom_IDNT_e,
      &kq__unit_rom_IDNT_e,        &l_unit_rom_IDNT_e,          &lam_unit_rom_IDNT_e,
      &lambda0_unit_rom_IDNT_e,    &lambdac__unit_rom_IDNT_e,   &lb_unit_rom_IDNT_e,
      &lbf_unit_rom_IDNT_e,        &lbmol_unit_rom_IDNT_e,      &lbt_unit_rom_IDNT_e,
      &lep_unit_rom_IDNT_e,        &liqpt_unit_rom_IDNT_e,      &lyr_unit_rom_IDNT_e,
      &m_unit_rom_IDNT_e,          &mEarth__unit_rom_IDNT_e,    &mSun__unit_rom_IDNT_e,
      &me__unit_rom_IDNT_e,        &mho_unit_rom_IDNT_e,        &mi_unit_rom_IDNT_e,
      &miUS_unit_rom_IDNT_e,       &mil_unit_rom_IDNT_e,        &mile_unit_rom_IDNT_e,
      &mille_unit_rom_IDNT_e,      &min_unit_rom_IDNT_e,        &mmHg_unit_rom_IDNT_e,
      &mn_unit_rom_IDNT_e,         &mol_unit_rom_IDNT_e,        &molK_unit_rom_IDNT_e,
      &mp__unit_rom_IDNT_e,        &mph_unit_rom_IDNT_e,        &mpme__unit_rom_IDNT_e,
      &mu0__unit_rom_IDNT_e,       &muB__unit_rom_IDNT_e,       &muN__unit_rom_IDNT_e,
      &nmi_unit_rom_IDNT_e,        &oz_unit_rom_IDNT_e,         &ozUK_unit_rom_IDNT_e,
      &ozfl_unit_rom_IDNT_e,       &ozt_unit_rom_IDNT_e,        &pc_unit_rom_IDNT_e,
      &pdl_unit_rom_IDNT_e,        &phi__unit_rom_IDNT_e,       &pk_unit_rom_IDNT_e,
      &psi_unit_rom_IDNT_e,        &pt_unit_rom_IDNT_e,         &ptUK_unit_rom_IDNT_e,
      &qe_unit_rom_IDNT_e,         &qepsilon0__unit_rom_IDNT_e, &qme__unit_rom_IDNT_e,
      &qt_unit_rom_IDNT_e,         &rad_unit_rom_IDNT_e,        &rd_unit_rom_IDNT_e,
      &rem_unit_rom_IDNT_e,        &rev_unit_rom_IDNT_e,        &rod_unit_rom_IDNT_e,
      &rpm_unit_rom_IDNT_e,        &s_unit_rom_IDNT_e,          &sb_unit_rom_IDNT_e,
      &sd_unit_rom_IDNT_e,         &sigma_unit_rom_IDNT_e,      &slug_unit_rom_IDNT_e,
      &st_unit_rom_IDNT_e,         &syr__unit_rom_IDNT_e,       &t_unit_rom_IDNT_e,
      &tbsp_unit_rom_IDNT_e,       &tec_unit_rom_IDNT_e,        &tep_unit_rom_IDNT_e,
      &tepC_unit_rom_IDNT_e,       &tepcC_unit_rom_IDNT_e,      &tepgC_unit_rom_IDNT_e,
      &tex_unit_rom_IDNT_e,        &therm_unit_rom_IDNT_e,      &toe_unit_rom_IDNT_e,
      &ton_unit_rom_IDNT_e,        &tonUK_unit_rom_IDNT_e,      &tr_unit_rom_IDNT_e,
      &tsp_unit_rom_IDNT_e,        &u_unit_rom_IDNT_e,          &yd_unit_rom_IDNT_e,
      &yr_unit_rom_IDNT_e,
  };
...
#ifdef USTL
    ustl::map<const char *, const mksa_unit *, ltstr>::const_iterator
        it = unit_conversion_map().find(s + 1),
        itend = unit_conversion_map().end();
#else
  std::map<const char *, const mksa_unit *, ltstr>::const_iterator it = unit_conversion_map().find(
                                                                       s + 1),
                                                                   itend =
                                                                       unit_conversion_map().end();
#endif
    gen res;
    lock_syms_mutex();
    if (it != itend)
  ...
  const gen * tab_usual_units[] = {&C_unit_rom_IDNT_e,   &F_unit_rom_IDNT_e,   &Gy_unit_rom_IDNT_e,
                                   &H_unit_rom_IDNT_e,   &Hz_unit_rom_IDNT_e,  &J_unit_rom_IDNT_e,
                                   &mho_unit_rom_IDNT_e, &N_unit_rom_IDNT_e,   &Ohm_unit_rom_IDNT_e,
                                   &Pa_unit_rom_IDNT_e,  &rad_unit_rom_IDNT_e, &S_unit_rom_IDNT_e,
                                   &Sv_unit_rom_IDNT_e,  &T_unit_rom_IDNT_e,   &V_unit_rom_IDNT_e,
                                   &W_unit_rom_IDNT_e,   &Wb_unit_rom_IDNT_e};
  ...
  const mksa_unit * const unitptr_tab[] = {
      &__A_unit, &__Angstrom_unit, &__Bq_unit, &__Btu_unit, &__C_unit, &__Curie_unit, &__E_unit,
      &__F_unit, &__FF_unit, &__Faraday_unit, &__Fdy_unit, &__G_unit, &__Gal, &__Gy_unit, &__H_unit,
      &__HFCC_unit, &__Hz_unit, &__IO_unit, &__J_unit, &__K_unit, &__L_unit, &__N_unit, &__NA_unit,
      &__Ohm_unit, &__P_unit, &__PSun_unit, &__Pa_unit, &__R_unit, &__REarth_unit, &__RSun_unit,
      &__R__unit, &__Rankine_unit, &__Rinfinity_unit, &__S_unit, &__St_unit, &__StdP_unit,
      &__StdT_unit, &__Sv_unit, &__T_unit, &__Torr_unit, &__V_unit, &__Vm_unit, &__W_unit,
      &__Wb_unit, &__Wh_unit, &__a_unit, &__a0_unit, &__acre_unit, &__alpha_unit, &__arcmin_unit,
      &__arcs_unit, &__atm_unit, &__au_unit, &__b_unit, &__bar_unit, &__bbl_unit, &__bblep_unit,
      &__boe_unit, &__bu, &__buUS, &__c3_unit, &__c_unit, &__cal_unit, &__cd_unit, &__cf_unit,
      &__chain_unit, &__ct_unit, &__cu_unit, &__d_unit, &__dB_unit, &__deg_unit,
      // &__degreeF_unit,
      &__dyn_unit, &__eV_unit, &__epsilon0_unit, &__epsilon0q_unit, &__epsilonox_unit,
      &__epsilonsi_unit, &__erg_unit, &__f0_unit, &__fath_unit, &__fbm_unit, &__fc_unit,
      &__fermi_unit, &__flam_unit, &__fm_unit, &__ft_unit, &__ftUS_unit, &__g_unit, &__g__unit,
      &__galC_unit, &__galUK_unit, &__galUS_unit, &__gf_unit, &__gmol_unit, &__gon_unit,
      &__grad_unit, &__grain_unit, &__h_unit, &__h__unit, &__ha_unit, &__hbar_unit, &__hp_unit,
      &__inH2O_unit, &__inHg_unit, &__in_unit, &__j_unit, &__k_unit, &__kg_unit, &__kip_unit,
      &__knot_unit, &__kph_unit, &__kq_unit, &__l_unit, &__lam_unit, &__lambda0_unit,
      &__lambdac_unit, &__lb_unit, &__lbf_unit, &__lbmol_unit, &__lbt_unit, &__lep_unit,
      &__liqpt_unit, &__lyr_unit, &__m_unit, &__mEarth_unit, &__mSun_unit, &__me_unit, &__mho_unit,
      &__mi_unit, &__miUS_unit, &__mil_unit, &__mile_unit, &__mille_unit, &__mn_unit, &__mmHg_unit,
      &__mn_unit, &__mol_unit, &__molK_unit, &__mp_unit, &__mph_unit, &__mpme_unit, &__mu0_unit,
      &__muB_unit, &__muN_unit, &__nmi_unit, &__oz_unit, &__ozUK_unit, &__ozfl_unit, &__ozt_unit,
      &__pc_unit, &__pdl_unit, &__phi_unit, &__pk_unit, &__psi_unit, &__pt_unit, &__ptUK_unit,
      &__qe_unit, &__qepsilon0_unit, &__qme_unit, &__qt_unit, &__rad_unit, &__rd_unit, &__rem_unit,
      &__tr_unit, &__rod_unit, &__rpm_unit, &__s_unit, &__sb_unit, &__sd_unit, &__sigma_unit,
      &__slug_unit, &__st_unit, &__syr_unit, &__t_unit, &__tbsp_unit, &__tec_unit, &__tep_unit,
      &__tepC_unit, &__tepcC_unit, &__tepgC_unit, &__tex, &__therm_unit, &__toe_unit, &__tonUK_unit,
      &__ton_unit, &__tr_unit, &__tsp_unit, &__u_unit, &__yd_unit, &__yr_unit,
#ifndef VISUALC
      &__micron_unit
#endif
  };
  ...
  const char * const unitname_tab[] = {
      "_A", "_Angstrom", "_Bq", "_Btu", "_C", "_Curie", "_E", "_F", "_FF", "_Faraday_", "_Fdy",
      "_G_", "_Gal", "_Gy", "_H", "_HFCC", "_Hz", "_IO_", "_J", "_K", "_L", "_N", "_NA_", "_Ohm",
      "_P", "_PSun_", "_Pa", "_R", "_REarth_", "_RSun_", "_R_", "_Rankine", "_Rinfinity_", "_S",
      "_St", "_StdP_", "_StdT_", "_Sv", "_T", "_Torr", "_V", "_Vm_", "_W", "_Wb", "_Wh", "_a",
      "_a0_", "_acre", "_alpha_", "_arcmin", "_arcs", "_atm", "_au", "_b", "_bar", "_bbl", "_bblep",
      "_boe", "_bu", "_buUS", "_c3_", "_c_", "_cal", "_cd", "_cf", "_chain", "_ct", "_cu", "_d",
      "_dB", "_deg",
      // "_degreeF",
      "_dyn", "_eV", "_epsilon0_", "_epsilon0q_", "_epsilonox_", "_epsilonsi_", "_erg", "_f0_",
      "_fath", "_fbm", "_fc", "_fermi", "_flam", "_fm", "_ft", "_ftUS", "_g", "_g_", "_galC",
      "_galUK", "_galUS", "_gf", "_gmol", "_gon", "_grad", "_grain", "_h", "_h_", "_ha", "_hbar_",
      "_hp", "_inH2O", "_inHg", "_inch", "_j", "_k_", "_kg", "_kip", "_knot", "_kph", "_kq_", "_l",
      "_lam", "_lambda0_", "_lambdac_", "_lb", "_lbf", "_lbmol", "_lbt", "_lep", "_liqpt", "_lyr",
      "_m", "_mEarth_", "_mSun_", "_me_", "_mho", "_mi", "_miUS", "_mil", "_mile", "_mille", "_min",
      "_mmHg", "_mn", "_mol", "_molK", "_mp_", "_mph", "_mpme_", "_mu0_", "_muB_", "_muN_", "_nmi",
      "_oz", "_ozUK", "_ozfl", "_ozt", "_pc", "_pdl", "_phi_", "_pk", "_psi", "_pt", "_ptUK",
      "_qe_", "_qepsilon0_", "_qme_", "_qt", "_rad", "_rd", "_rem", "_rev", "_rod", "_rpm", "_s",
      "_sb", "_sd_", "_sigma_", "_slug", "_st", "_syr_", "_t", "_tbsp", "_tec", "_tep", "_tepC",
      "_tepcC", "_tepgC", "_tex", "_therm", "_toe", "_ton", "_tonUK", "_tr", "_tsp", "_u", "_yd",
      "_yr",
#ifndef VISUALC
      "_\u03BC"
  // "_µ"
  ...
  vecteur mksa_convert(const identificateur & g, GIAC_CONTEXT) {
    ...
    int l = int(s.size());
#ifdef USTL
    ustl::pair<const char * const * const, const char * const * const> pp =
        ustl::equal_range(unitname_tab, unitname_tab_end, s.c_str(), mksa_tri3());
#else
  std::pair<const char * const * const, const char * const * const> pp =
      equal_range(unitname_tab, unitname_tab_end, s.c_str(), mksa_tri3());
#endif
  ...
  std::map<const char *, const mksa_unit *, ltstr>::const_iterator it = unit_conversion_map().find(
...
#ifdef USTL
      ustl::pair<const char * const * const, const char * const * const> pp =
          ustl::equal_range(unitname_tab, unitname_tab_end, ("_" + s).c_str(), mksa_tri3());
#else
    std::pair<const char * const * const, const char * const * const> pp =
        equal_range(unitname_tab, unitname_tab_end, ("_" + s).c_str(), mksa_tri3());
#endif
      if (pp.first != pp.second && pp.second != unitname_tab_end)
        mksa_register_unit(*pp.first, unitptr_tab[pp.first - unitname_tab]);
      it = unit_conversion_map().find(s.c_str());
    ...
    if (it == itend)
      return makevecteur(
          operator_times(res, find_or_make_symbol("_" + s, false, contextptr), contextptr));
  ...
  gen _usimplify(const gen & g, GIAC_CONTEXT) {
    ...
    for (; it != itend; ++it) {
      ...
      for (int i = tmp.size(); i < 5; ++i)
        tmp.push_back(zero);
      if (tmp == v)
        return _ufactor(gen(makevecteur(g, symbolic(at_unit, makevecteur(1, **it))), _SEQ__VECT),
                        contextptr);
    }
    ...
    for (; it != itend; ++it) {
      ...
      for (int j = 0; j < 2; j++) {
        ...
        if (pos) {
          if (j)
            return _ufactor(
                gen(makevecteur(g, symbolic(at_unit, makevecteur(1, unitpow(**it, -1)))),
                    _SEQ__VECT),
                contextptr);
          else
            return _ufactor(
                gen(makevecteur(g, symbolic(at_unit, makevecteur(1, **it))), _SEQ__VECT),
                contextptr);
        }
      }
    }
  ...
  string printasunit(const gen & feuille, const char * sommetstr, GIAC_CONTEXT) {
    ...
    vecteur & v = *feuille._VECTptr;
    string tmp0(v[1].print(contextptr)), tmp;
    bool skip = true;
  ...
  const unary_function_ptr * binary_op_tab() {
    static const unary_function_ptr binary_op_tab_ptr[] = {*at_plus,
                                                           *at_prod,
                                                           *at_pow,
                                                           *at_and,
                                                           *at_ou,
...
gen user_operator(const gen & g, GIAC_CONTEXT) {
  ...
  vector<unary_function_ptr>::iterator it = user_operator_list.begin(),
                                       itend = user_operator_list.end();
  for (; it != itend; ++it) {
    if (it->ptr()->s == ss) {
      break;
    }
  ...
  if (it != itend) {
    ...
    if (!ptr)
      return zero;
    if ((nargs == 3 && ptr->f == v[1] && v[2].type == _INT_ && v[2].subtype == _INT_MUPADOPERATOR &&
         v[2].val == _DELETE_OPERATOR) ||
        (nargs == 2 && v[1].type == _INT_ && v[1].subtype == _INT_MUPADOPERATOR &&
         v[1].val == _DELETE_OPERATOR)) {
  ...
  gen _SetFold(const gen & g, GIAC_CONTEXT) {
    ...
    if (!is_zero(g) && g.type != _IDNT)
      return gensizeerr(contextptr);
    bool ok = is_zero(g);
    if (g.type == _IDNT && g._IDNTptr->value && g._IDNTptr->value->type == _VECT &&
        g._IDNTptr->value->subtype == _FOLDER__VECT)
      ok = true;
    if (ok || (g.type == _IDNT && g._IDNTptr->id_name &&
               (strcmp(g._IDNTptr->id_name, "main") == 0 || strcmp(g._IDNTptr->id_name, "home")))) {
  ...
  gen _piecewise(const gen & g, GIAC_CONTEXT) {
    ...
    for (int i = 0; i < s / 2; ++i) {
      ...
      if (conditional_symbolic_equal(test, condition, contextptr)) {
        ...
        vecteur rest(v.begin() + 2 * i, v.end());
        rest[0] = condition;
  ...
  static define_unary_function_eval2_quoted(__piecewise, &_piecewise, _piecewise_s,
                                            &printaspiecewise);
  define_unary_function_ptr5(at_piecewise, alias_at_piecewise, &__piecewise, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_threads_allowed, alias_at_threads_allowed, &__threads_allowed, 0,
                             true);
  ...
  define_unary_function_ptr5(at_mpzclass_allowed, alias_at_mpzclass_allowed, &__mpzclass_allowed, 0,
                             true);
  ...
  gen piecewisetowhen(const gen & g, GIAC_CONTEXT) {
    ...
    if (s >= 2 && v[0].type == _INT_) {
      if (v[0].val)
        ...
        return s == 2 ? bounded_function(contextptr)
                      : piecewisetowhen(vecteur(v.begin() + 2, v.end()), contextptr);
    }
    if (s == 2) {
  ...
  const unary_function_ptr * const piecewise_tab =
      (const unary_function_ptr * const)piecewise_tab_alias;
  ...
  gen whentosign(const gen & g, GIAC_CONTEXT) {
    ...
    if (v[0].is_symb_of_sommet(at_and) && v[0]._SYMBptr->feuille.type == _VECT) {
      ...
      if (vand.size() == 2)
        return whentosign(
            makevecteur(vand[0], whentosign(makevecteur(vand[1], v[1], v[2]), contextptr), v[2]),
            contextptr);
      if (vand.size() > 2) {
        gen vandlast = vand.back();
        vand.pop_back();
        return whentosign(
            makevecteur(vandlast,
                        whentosign(makevecteur(symbolic(at_and, vand), v[1], v[2]), contextptr),
                        v[2]),
            contextptr);
      }
    }
    if (v[0].is_symb_of_sommet(at_ou) && v[0]._SYMBptr->feuille.type == _VECT) {
      ...
      if (vor.size() == 2)
        return whentosign(
            makevecteur(vor[0], v[1], whentosign(makevecteur(vor[1], v[1], v[2]), contextptr)),
            contextptr);
      if (vor.size() > 2) {
        gen vorlast = vor.back();
        vor.pop_back();
        return whentosign(
            makevecteur(vorlast, v[1],
                        whentosign(makevecteur(symbolic(at_and, vor), v[1], v[2]), contextptr)),
            contextptr);
      }
    }
    ...
    if (!ok && (v[0].is_symb_of_sommet(at_inferieur_strict) ||
                v[0].is_symb_of_sommet(at_inferieur_egal))) {
  ...
  gen when2sign(const gen & g, GIAC_CONTEXT) {
    if (equalposcomp(lidnt(g), unsigned_inf))
      *logptr(contextptr) << gettext("when2sign does not work properly with infinities. Replace "
                                     "inf by Inf and run limit after.")
                          << '\n';
  ...
  bool is_array_index(const gen & m, const gen & i, GIAC_CONTEXT) {
    if (i.type == _VECT) {
      for (unsigned j = 0; j < i._VECTptr->size(); ++j) {
        gen g = (*i._VECTptr)[j];
        if (g.type == _IDNT || g.is_symb_of_sommet(at_equal) ||
            g.is_symb_of_sommet(at_deuxpoints) || g.is_symb_of_sommet(at_sto))
          continue;
        return true;
      }
    } else {
  ...
  gen _struct_dot(const gen & g, GIAC_CONTEXT) {
    ...
    if (b.type == _SYMB) {
      ...
      if (equalposcomp(plot_sommets, u) || u == at_clear || u == at_scatterplot ||
          u == at_diagrammebatons)
    ...
    if (a.type == _IDNT) {
      ...
      if (tmp.type == _MAP && b.is_symb_of_sommet(at_of)) {
        ...
        if (f.type == _VECT && f._VECTptr->size() == 2) {
          ...
          if (v.size() == 2 && v.front().type == _IDNT &&
              strcmp(v.front()._IDNTptr->id_name, "update") == 0) {
      ...
      if (tmp.type == _IDNT && (strcmp(tmp._IDNTptr->id_name, "numpy") == 0 ||
                                strcmp(tmp._IDNTptr->id_name, "pylab") == 0 ||
                                strcmp(tmp._IDNTptr->id_name, "matplotlib") == 0)) {
        if (b.type == _SYMB) {
      ...
      if (tmp.type == _IDNT && (strcmp(tmp._IDNTptr->id_name, "math") == 0 ||
      ...
      if (tmp.type == _VECT && b.type == _SYMB) {
        ...
        if ((b._SYMBptr->sommet == at_suppress || b._SYMBptr->sommet == at_clear) &&
            b._SYMBptr->feuille.type == _VECT && b._SYMBptr->feuille._VECTptr->empty()) {
          tmp._VECTptr->clear();
          return tmp;
        }
      }
    ...
    if ((a.type == _IDNT || a.type == _SYMB) &&
        (u == at_revlist || u == at_reverse || u == at_sort || u == at_append || u == at_prepend ||
         u == at_concat || u == at_extend || u == at_rotate || u == at_shift || u == at_suppress ||
         u == at_remove || u == at_insert))
      return sto(f, a, contextptr);
    return f;
  }
  static const char _struct_dot_s[] = ".";
  static define_unary_function_eval4_index(175, __struct_dot, &_struct_dot, _struct_dot_s,
                                           &printsommetasoperator, &texprintsommetasoperator);
  define_unary_function_ptr5(at_struct_dot, alias_at_struct_dot, &__struct_dot, _QUOTE_ARGUMENTS,
                             true);
  ...
  define_unary_function_ptr5(at_giac_assert, alias_at_giac_assert, &__giac_assert, _QUOTE_ARGUMENTS,
                             T_RETURN);
