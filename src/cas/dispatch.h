...
#define DOUBLEVAL 1
  ...
  enum point_styles { _STYLE_DOT = 0, _STYLE_BOX = 1, _STYLE_CROSS = 2, _STYLE_PLUS = 3 };

  enum line_styles { _STYLE_FULL = 0, _STYLE_DOTTED = 1, _STYLE_DASHED = 2 };
...
#pragma diag_suppress 61
  ...
  enum maple_libs { _LINALG = 0, _NUMTHEORY = 1, _GROEBNER = 2 };
