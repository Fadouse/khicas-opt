...
namespace giac {
  ...
  extern double gnuplot_xmin, gnuplot_xmax, gnuplot_ymin, gnuplot_ymax, gnuplot_zmin, gnuplot_zmax,
      gnuplot_tmin, gnuplot_tmax, gnuplot_tstep, global_window_xmin, global_window_xmax,
      global_window_ymin, global_window_ymax, x_tick, y_tick; // ranges
...
std::vector<logo_turtle> & turtle_stack();
  ...
  bool find_best(std::vector<int> & selected, const gen & p, double eps, int try_perp_history_pos,
  ...
  gen plotfunc(const gen & f, const gen & vars, const vecteur & attributs, int densityplot,
               ...
               int jstep, bool showeq, GIAC_CONTEXT);
  ...
  gen plot_array(const std::vector<std::vector<double>> & fij, int imax, int jmax, double xmin,
                 double xmax, double dx, double ymin, double ymax, double dy, const vecteur & lz,
  ...
  gen approx_area(const gen & f, const gen & x, const gen & a, const gen & b, int n, int method,
                  GIAC_CONTEXT);
...
extern unary_function_eval __click;
  ...
  gen xyztrange(double xmin, double xmax, double ymin, double ymax, double zmin, double zmax,
                ...
                int axes, double class_minimum, double class_size, bool gnuplot_hidden3d,
                bool gnuplot_pm3d);
