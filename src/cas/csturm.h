...
namespace giac {
  ...
  // eval P at r+/-eps
  void horner_minmax(const vecteur & P, bool Preal, const gen & r, const gen & eps, gen & Prmin,
                     gen & Prmax);
  ...
  bool complex_roots(const modpoly & P, const gen & a0, const gen & b0, const gen & a1,
                     const gen & b1, vecteur & roots, gen & pgcd, double eps);
  ...
  vecteur keep_in_rectangle(const vecteur & croots, const gen A0, const gen &, const gen & A1,
  ...
  bool vas(const modpoly & P, const gen & a, const gen & b, double eps, vecteur & vasres,
