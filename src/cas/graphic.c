...
void js_add_graphic(JSContext * ctx) {
  ...
  JS_SetPropertyStr(ctx, graphic, "setPixel", JS_NewCFunction(ctx, js_set_pixel, "setPixel", 1));
  JS_SetPropertyStr(ctx, graphic, "fillRect", JS_NewCFunction(ctx, js_fill_rect, "fillRect", 1));
