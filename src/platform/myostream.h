...
namespace giac {
  ...
  public:
    template <typename T> friend my_ostream & operator<<(my_ostream &, const T &);
  ...
  template <typename T> inline my_ostream & operator<<(my_ostream & out, const T & value) {
    static_cast<std::ostream &>(out) << value;
    return out;
  }

  //  overload for double
  template <> inline my_ostream & operator<<(my_ostream & out, const double & value) {
    char buf[50];
  ...
  //  overload for float
  template <> inline my_ostream & operator<<(my_ostream & out, const float & value) {
    char buf[50];
    my_sprintf(buf, "%f", value);
    return out << buf;
  }
  ...
  //  overload for int
  template <> inline my_ostream & operator<<(my_ostream & out, const int & value) {
    char buf[50];
  ...
  template <> inline my_ostream & operator<<(my_ostream & out, const unsigned int & value) {
    char buf[50];
