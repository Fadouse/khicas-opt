...
namespace xcas {
  ...
  giac::gen Equation_nullstring(const giac::attributs & a, int windowhsize,
                                const giac::context * contextptr);
  ...
  giac::gen * Equation_selected(giac::gen & g, giac::attributs & attr, int windowhsize,
                                giac::vecteur & position, bool active_search,
                                const giac::context *);
