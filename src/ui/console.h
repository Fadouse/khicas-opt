...
int QRdisp(const char * text, const char * msg1 = "  Flash this to",
           const char * msg2 = "  clone session", const char * msg3 = "  on smartphone",
           const char * msg4 = 0);
...
inline bool inputdouble(const char * msg1, double & d, const giac::context *) {
  return inputdouble(msg1, d);
}
...
enum CONSOLE_LINE_TYPE { LINE_TYPE_INPUT = 0, LINE_TYPE_OUTPUT = 1 };

enum CONSOLE_CASE { LOWER_CASE, UPPER_CASE };
...
#define is_wchar(c)                                                                                \
  ((c == 0x7F) || (c == 0xF7) || (c == 0xF9) || (c == 0xE5) || (c == 0xE6) || (c == 0xE7))
