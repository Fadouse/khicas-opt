...
验证源码：`checkpoint/polar-stability-cycle21-2026a`。
正式题库与用户题目共 **690 条通过记录**：**685 条精确验证、5 条导数采样通过、0 条数值常量检查通过**。
保留各题库的编号和重复项；仅去除输入空白后有 667 种输入文本，这不是数学意义的去重。

“核对参考结果”来自已验证题库，用于阅读和比对，并不保证与计算器实际打印的写法相同。
不定积分省略积分常数；实根、对数和反三角函数须遵守原题定义域。采样检查不能代替完整符号证明。
主机使用仓库积分、归一化、FXCG 化简及计算器实际链接的 zusual 基础函数实现；这些通过记录不代表 CG50 实机耗时或实机全部通过。
...
[原题与定义域](../tests/polar-cycle21-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle21-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC21-I1` | `simplify(integrate(abs(x-a),x,0,1))` | `piecewise(a<=0,1/2-a,a<1,a^2-a+1/2,a-1/2)` | 精确验证 |
| `PC21-I2` | `simplify(integrate(1/sqrt(1-x^4),x))` | `EllipticF(asin(x),-1)` | 精确验证 |

## 用户新增崩溃积分（2 条）

[原题与定义域](../tests/user-crashes-polar21-integrals.json) · [实际输出和验证记录](benchmarks/user-crashes-polar21-integrals-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC21-USER1` | `integrate(x/sin(x)^2,x,pi/4,pi/2)` | `pi/4+ln(2)/2` | 精确验证 |
| `PC21-USER2` | `integrate(1/(sqrt(x + 1)*(x^2 + 1)),x,0,+infinity)` | `-sqrt(2)*(atan((2 - sqrt(2 + 2*sqrt(2)))/sqrt(-2 + 2*sqrt(2))) + atan((2 + sqrt(2 + 2*sqrt(2)))/sqrt(-2 + 2*sqrt(2))))/(2*sqrt(-2 + 2*sqrt(2))) - sqrt(2)*ln((1 + sqrt(2) + sqrt(2 + 2*sqrt(2)))/(-sqrt(2 + 2*sqrt(2)) + 1 + sqrt(2)))/(4*sqrt(2 + 2*sqrt(2))) + sqrt(2)*pi/(2*sqrt(-2 + 2*sqrt(2)))` | 精确验证 |

## 极坐标优化第二十轮积分（2 条）

[原题与定义域](../tests/polar-cycle20-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle20-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC20-I1` | `simplify(integrate(1/(x^2+2*a*x+1),x))` | `piecewise(x^2+2*a*x+1==0,undef,a^2<1,atan((x+a)/sqrt(1-a^2))/sqrt(1-a^2),a^2==1,-1/(x+a),ln(abs((x+a-sqrt(a^2-1))/(x+a+sqrt(a^2-1))))/(2*sqrt(a^2-1)))` | 精确验证 |
| `PC20-I2` | `simplify(integrate(asin(x)/sqrt(1+x),x))` | `piecewise(x<=-1,undef,x>1,undef,2*sqrt(1+x)*asin(x)+4*sqrt(1-x))` | 精确验证 |

## 极坐标优化第十九轮积分（2 条）

[原题与定义域](../tests/polar-cycle19-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle19-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC19-I1` | `simplify(integrate(exp(x)*abs(exp(x)-1)/(1+exp(2*x)),x))` | `piecewise(x<0,-ln((1+exp(2*x))/2)/2+atan(exp(x))-pi/4,ln((1+exp(2*x))/2)/2-atan(exp(x))+pi/4)` | 精确验证 |
| `PC19-I2` | `simplify(integrate(ln(x+sqrt(x^2-1))/x^2,x))` | `piecewise(x<1,undef,acos(1/x)-ln(x+sqrt(x^2-1))/x)` | 精确验证 |

## 极坐标优化第十八轮积分（2 条）

[原题与定义域](../tests/polar-cycle18-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle18-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC18-I1` | `simplify(integrate(sqrt(x)/(x-1)^2,x))` | `piecewise(x<0,undef,x==1,undef,-sqrt(x)/(x-1)+ln(abs((sqrt(x)-1)/(sqrt(x)+1)))/2)` | 精确验证 |
| `PC18-I2` | `simplify(integrate(ln(abs(1-sqrt(x))),x))` | `piecewise(x<0,undef,x==1,undef,(x-1)*ln(abs(1-sqrt(x)))-x/2-sqrt(x))` | 精确验证 |

## 极坐标优化第十七轮积分（2 条）

[原题与定义域](../tests/polar-cycle17-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle17-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC17-I1` | `simplify(integrate(ln(x)/(1+x)^2,x,0,1))` | `-ln(2)` | 精确验证 |
| `PC17-I2` | `simplify(integrate(x/(sqrt(1+x)+sqrt(1-x)),x))` | `piecewise(x<-1,undef,x>1,undef,((1+x)*sqrt(1+x)+(1-x)*sqrt(1-x))/3)` | 精确验证 |

## 极坐标优化第十六轮积分（含一题历史回归）（3 条）

[原题与定义域](../tests/polar-cycle16-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle16-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC16-I1` | `simplify(integrate(ln(x)^2/x^2,x))` | `piecewise(x>0,-(ln(x)^2+2*ln(x)+2)/x,undef)` | 精确验证 |
| `PC16-I2` | `simplify(integrate(x*sin(x)/(1+cos(x)^2),x,0,pi))` | `pi^2/4` | 精确验证 |
| `PC16-I3` | `simplify(integrate(sqrt(1+sin(x)),x,0,2*pi))` | `4*sqrt(2)` | 精确验证 |

## 极坐标优化第十五轮新增积分（2 条）

[原题与定义域](../tests/polar-cycle15-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle15-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC15-I1` | `simplify(integrate(x^2*exp(2*x)*sin(3*x),x))` | `exp(2*x)*((338*x^2+130*x-92)*sin(3*x)+(-507*x^2+312*x-18)*cos(3*x))/2197` | 精确验证 |
| `PC15-I2` | `simplify(integrate(1/(5+3*cos(x))^3,x))` | `59*(x-2*atan(sin(x)/(3+cos(x))))/2048-45*sin(x)/(512*(5+3*cos(x)))-3*sin(x)/(32*(5+3*cos(x))^2)` | 精确验证 |

## 极坐标优化第十四轮新增积分（2 条）

[原题与定义域](../tests/polar-cycle14-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle14-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC14-I1` | `simplify(integrate(1/(x^4+4),x))` | `ln((x^2+2*x+2)/(x^2-2*x+2))/16+(atan(x+1)+atan(x-1))/8` | 精确验证 |
| `PC14-I2` | `simplify(integrate(1/(2+sin(x))^2,x))` | `2*(x+2*atan(cos(x)/(2+sqrt(3)+sin(x))))/(3*sqrt(3))+cos(x)/(3*(2+sin(x)))` | 精确验证 |

## 极坐标优化第十三轮新增积分（2 条）

[原题与定义域](../tests/polar-cycle13-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle13-integrals-polar21-2026a.json)

| 编号 | 可输入的题目 | 核对参考结果 | 验证 |
| --- | --- | --- | --- |
| `PC13-I1` | `simplify(integrate(x^2/sqrt(x^2+4),x))` | `x*sqrt(x^2+4)/2-2*ln((x+sqrt(x^2+4))/2)` | 精确验证 |
| `PC13-I2` | `simplify(integrate(1/(2+cos(x)),x))` | `(x-2*atan(sin(x)/(2+sqrt(3)+cos(x))))/sqrt(3)` | 精确验证 |

## 极坐标优化第十二轮新增积分（2 条）

[原题与定义域](../tests/polar-cycle12-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle12-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle11-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle11-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle10-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle10-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle9-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle9-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle8-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle8-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle7-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle7-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle6-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle6-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle5-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle5-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle4-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle4-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle3-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle3-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle2-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle2-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/polar-cycle1-integrals.json) · [实际输出和验证记录](benchmarks/polar-cycle1-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/user-integrals.json) · [实际输出和验证记录](benchmarks/user-eight-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/user-extra-integrals.json) · [实际输出和验证记录](benchmarks/user-extra-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/user-challenge-integrals.json) · [实际输出和验证记录](benchmarks/user-challenge-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/calculus-corpus.json) · [实际输出和验证记录](benchmarks/calculus-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-corpus.json) · [实际输出和验证记录](benchmarks/generalization-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle2.json) · [实际输出和验证记录](benchmarks/cycle2-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle3.json) · [实际输出和验证记录](benchmarks/cycle3-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle4.json) · [实际输出和验证记录](benchmarks/cycle4-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle5.json) · [实际输出和验证记录](benchmarks/cycle5-cycle8-stack-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle6.json) · [实际输出和验证记录](benchmarks/cycle6-cycle8-stack-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle7.json) · [实际输出和验证记录](benchmarks/cycle7-cycle8-stack-polar21-2026a.json)
...
[原题与定义域](../tests/generalization-cycle8.json) · [实际输出和验证记录](benchmarks/cycle8-stack-polar21-2026a.json)
...
[原题与定义域](../tests/basic-finite-integrals.json) · [实际输出和验证记录](benchmarks/basic-finite-cycle8-polar21-2026a.json)
...
[原题与定义域](../tests/cycle7-tail-mellin.json) · [实际输出和验证记录](benchmarks/cycle7-tail-mellin-cycle8-stack-polar21-2026a.json)
...
[原题与定义域](../tests/cycle8-gamma-log.json) · [实际输出和验证记录](benchmarks/cycle8-gamma-log-stack-polar21-2026a.json)
...
[原题与定义域](../tests/user-acceptance-passed-dilog.json) · [实际输出和验证记录](benchmarks/user-acceptance-passed-polar21-2026a.json)
...
[原题与定义域](../tests/user-reported-five-gaps.json) · [实际输出和验证记录](benchmarks/user-reported-five-gaps-polar21-2026a.json)
...
[原题与定义域](../tests/user-matrix-next.json) · [实际输出和验证记录](benchmarks/user-matrix-next-polar21-2026a.json)
...
[原题与定义域](../tests/dilogarithm-corpus.json) · [实际输出和验证记录](benchmarks/dilogarithm-corpus-polar21-2026a.json)
...
[原题与定义域](../tests/trig-log-corpus.json) · [实际输出和验证记录](benchmarks/trig-log-corpus-polar21-2026a.json)
...
[原题与定义域](../tests/mixed-round1-integrals.json) · [实际输出和验证记录](benchmarks/mixed1-integrals-polar21-2026a.json)
...
[原题与定义域](../tests/mixed-round2-integrals.json) · [实际输出和验证记录](benchmarks/mixed2-integrals-polar21-2026a.json)
